import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as n}from"./iframe-C-ct1XZp.js";import{g as V}from"./responsive-DX0Wnnwv.js";import{c as S}from"./cn-CNMN3A1O.js";import"./preload-helper-PPVm8Dsz.js";const a=({label:l,size:f="md",variant:k="primary",className:T="",checked:x=!1,onChange:t,disabled:r=!1,id:w,...z})=>{const C=s=>{r||t&&t(s.target.checked)},M=s=>V(s,{sm:"w-10 h-5 after:h-4 after:w-4",md:"w-14 h-7 after:h-6 after:w-6",lg:"w-16 h-8 after:h-7 after:w-7"}),L=(s,N)=>{if(N)return"bg-gray-600 peer-checked:bg-gray-500 opacity-50 cursor-not-allowed";const j={primary:"bg-gray-600 peer-checked:bg-linear-(--gradient-accent) peer-focus:ring-primary",secondary:"bg-gray-600 peer-checked:bg-secondary peer-focus:ring-secondary",accent:"bg-gray-600 peer-checked:bg-accent peer-focus:ring-accent"};return j[s]||j.primary},A=S("relative inline-flex items-center",r?"cursor-not-allowed opacity-50":"cursor-pointer"),q=S(M(f),L(k,r),"peer-focus:outline-none rounded-full peer","peer-checked:after:translate-x-full peer-checked:after:border-white","after:content-[''] after:absolute after:top-[2px] after:left-[2px]","after:bg-white after:rounded-full after:transition-all","transition-colors duration-300"),D=S("flex items-center justify-between",l&&"space-x-3",T);return e.jsxs("div",{className:D,children:[l&&e.jsx("label",{htmlFor:w,className:`text-default font-medium ${r?"text-muted opacity-50":"cursor-pointer"}`,children:l}),e.jsxs("label",{className:A,children:[e.jsx("input",{type:"checkbox",className:"sr-only peer",checked:x,onChange:C,disabled:r,id:w,...z}),e.jsx("div",{className:q})]})]})};a.__docgenInfo={description:`A futuristic cyberpunk-themed toggle switch with neon glow and smooth transitions.
