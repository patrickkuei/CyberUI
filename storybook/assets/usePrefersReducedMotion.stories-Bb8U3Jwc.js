import{j as o}from"./jsx-runtime-D_zvdyIk.js";import{u as t}from"./usePrefersReducedMotion-lcrjIEUx.js";import"./iframe-DSFUJkaO.js";import"./preload-helper-D9Z9MdNV.js";const l={title:"Hooks/usePrefersReducedMotion",tags:["autodocs"],parameters:{layout:"centered",docs:{description:{component:`Returns \`true\` while the user's OS or browser asks for reduced motion (\`prefers-reduced-motion: reduce\`), and re-renders when that preference changes. Returns \`false\` during server rendering and wherever \`window.matchMedia\` is unavailable.
