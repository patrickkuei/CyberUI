...
@default true`,defaultValue:{value:"true",computed:!1}}}};const _={title:"Components/Skeleton",component:r,parameters:{layout:"centered",docs:{description:{component:`A cyberpunk-themed skeleton loader component for displaying loading placeholders with smooth animations.
...
}`,...w.parameters?.docs?.source}}};const B=["Text","Circular","Rectangular","AvatarText","ButtonGroup","Card","Small","Medium","Large","WithoutAnimation","CustomDimensions","AllVariants","AllSizes","LoadingStates","CyberpunkDemo"];export{S as AllSizes,j as AllVariants,x as AvatarText,v as ButtonGroup,p as Card,c as Circular,f as CustomDimensions,w as CyberpunkDemo,N as Large,y as LoadingStates,g as Medium,u as Rectangular,h as Small,m as Text,b as WithoutAnimation,B as __namedExportsOrder,_ as default};
