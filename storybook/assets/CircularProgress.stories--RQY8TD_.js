import{j as e}from"./jsx-runtime-u17CrQMm.js";import"./iframe-CcYmHeTV.js";import{c as f}from"./cn-CNMN3A1O.js";import"./preload-helper-PPVm8Dsz.js";const p=({progress:c,radius:n,className:d="",children:l,ariaLabel:m})=>{const i=2*Math.PI*n,r=i/2,u=r*(1-c/100),g=r*(1-c/100);return e.jsxs("div",{className:f("relative",d),role:"progressbar","aria-label":m||"Progress","aria-valuenow":Math.max(0,Math.min(100,c)),"aria-valuemin":0,"aria-valuemax":100,children:[e.jsxs("svg",{className:"w-full h-full overflow-visible",viewBox:"0 0 50 50",children:[e.jsx("circle",{cx:"25",cy:"25",r:n,fill:"none",stroke:"var(--color-accent)",strokeWidth:"4",strokeLinecap:"butt",strokeDasharray:`${r*.98} ${i}`,strokeDashoffset:u,transform:"rotate(-90 25 25)",style:{filter:"drop-shadow(0 0 8px var(--color-accent))"}}),e.jsx("circle",{cx:"25",cy:"25",r:n,fill:"none",stroke:"var(--color-primary)",strokeWidth:"4",strokeLinecap:"butt",strokeDasharray:`${r*.98} ${i}`,strokeDashoffset:g,transform:"rotate(90 25 25)",style:{filter:"drop-shadow(0 0 8px var(--color-primary))"}})]}),l&&e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:l})]})};p.__docgenInfo={description:`A beautiful circular progress indicator with neon glow and dual-tone stroke.

@example
<CircularProgress progress={60} radius={20}>
  <span className="text-xs font-mono">60%</span>
</CircularProgress>`,methods:[],displayName:"CircularProgress",props:{progress:{required:!0,tsType:{name:"number"},description:"Progress value (0-100)."},radius:{required:!0,tsType:{name:"number"},description:"Radius of the circle in pixels."},className:{required:!1,tsType:{name:"string"},description:"Optional custom class name",defaultValue:{value:"''",computed:!1}},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Optional content to render in the center of the circle"},ariaLabel:{required:!1,tsType:{name:"string"},description:"Accessible label for screen readers"}}};const b={title:"Components/CircularProgress",component:p,parameters:{layout:"centered",docs:{description:{component:`A cyberpunk-themed circular progress indicator with neon styling and smooth animations.
...
}`,...o.parameters?.docs?.source}}};const w=["Default","WithText","Small","Large"];export{s as Default,o as Large,t as Small,a as WithText,w as __namedExportsOrder,b as default};
