import{j as m}from"./jsx-runtime-u17CrQMm.js";import"./iframe-B52jae2o.js";import{g,R as d}from"./responsive-ChLhblTX.js";import"./preload-helper-PPVm8Dsz.js";const u=({progress:t,size:o="md",className:c=""})=>{const p=l=>g(l,d.linearProgress.width),v=l=>g(l,d.linearProgress.height),f=p(o),i=v(o),h=["bg-surface","rounded-full","shadow-inner",i,c||f].join(" "),w=["bg-gradient-to-r","from-accent","to-primary","rounded-full","shadow-lg-accent","transition-all","duration-500","ease-out",i].join(" ");return m.jsx("div",{className:h,role:"progressbar","aria-valuenow":Math.max(0,Math.min(100,t)),"aria-valuemin":0,"aria-valuemax":100,children:m.jsx("div",{className:w,style:{width:`${t}%`}})})};u.__docgenInfo={description:"",methods:[],displayName:"LinearProgress",props:{progress:{required:!0,tsType:{name:"number"},description:"Progress value (0-100)."},size:{required:!1,tsType:{name:"union",raw:"T | ResponsiveObject<T>",elements:[{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},{name:"signature",type:"object",raw:`{
  base?: T;
  sm?: T;
  md?: T;
  lg?: T;
...
}`,...n.parameters?.docs?.source}}};const S=["Default","Small","Large","Responsive","CustomWidth"];export{n as CustomWidth,e as Default,a as Large,r as Responsive,s as Small,S as __namedExportsOrder,P as default};
