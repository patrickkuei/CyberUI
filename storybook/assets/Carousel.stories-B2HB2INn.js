...
\`\`\`
`}}},tags:["autodocs"],argTypes:{images:{control:!1,description:"Array of images to display in the carousel"},currentIndex:{control:!1,description:"Current slide index (managed internally)"},onChange:{control:!1,description:"Callback function when slide changes"},size:{control:{type:"select"},options:["sm","md","lg"],description:"Carousel size (supports responsive values)"},autoPlay:{control:"boolean",description:"Enable auto-play functionality"},interval:{control:{type:"number",min:1e3,max:1e4,step:500},description:"Auto-play interval in milliseconds"},infinite:{control:"boolean",description:"Enable infinite loop"},transition:{control:{type:"select"},options:["slide","fade","matrix","signal-glitch"],description:"Transition effect type"},objectFit:{control:{type:"select"},options:["cover","contain"],description:"Image display behavior"},showArrows:{control:"boolean",description:"Show navigation arrows"},showIndicators:{control:"boolean",description:"Show slide indicators"},disableImagePreview:{control:"boolean",description:"Disable click-to-expand on images"},fallbackStyle:{control:{type:"inline-radio"},options:["gradient","scanline"],description:"Built-in stand-in style for any slide with no image source"},glitchRate:{control:{type:"range",min:0,max:1,step:.1},description:"Control signal-glitch effect frequency (0.0-1.0 for probability, boolean for on/off)"}},args:{size:"md",autoPlay:!0,interval:3e3,infinite:!0,transition:"slide",objectFit:"cover",showArrows:!0,showIndicators:!0,disableImagePreview:!1,glitchRate:1}},u=[{src:"image_demo_1.jpg",alt:"Cyberpunk cityscape",caption:"Neo-Tokyo District 7"},{src:"image_demo_2.jpg",alt:"Corporate architecture",caption:"Megacorp Tower"},{src:"image_demo_3.jpg",alt:"Underground market",caption:"Data Exchange"}],j={parameters:{docs:{story:{inline:!1,iframeHeight:400}}},args:{images:u},render:a=>{const[n,o]=i.useState(0);return e.jsx("div",{className:"flex items-center justify-center min-h-screen bg-base p-8",children:e.jsxs("div",{className:"w-full max-w-2xl space-y-4",children:[e.jsx(d,{...a,currentIndex:n,onChange:o}),e.jsx("div",{className:"text-center",children:e.jsxs("p",{className:"text-muted text-xs",children:["⚠️ Note: Controls are disabled due to state sync issues.",e.jsx("br",{})]})})]})})}},C={parameters:{docs:{story:{inline:!1,iframeHeight:800}}},render:()=>{const[a,n]=i.useState(0),[o,g]=i.useState(0),[p,x]=i.useState(0),[m,y]=i.useState(0);return e.jsxs("div",{className:"flex flex-col gap-8 p-6 bg-base min-h-screen",children:[e.jsx("div",{className:"space-y-4",children:e.jsx("h4",{className:"text-secondary font-semibold",children:"All Transition Types"})}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("h5",{className:"text-accent font-semibold",children:"Slide Transition"}),e.jsx("span",{className:"text-muted text-xs font-mono bg-surface px-2 py-1 rounded",children:"default"})]}),e.jsx("div",{className:"max-w-lg",children:e.jsx(d,{images:u,currentIndex:a,onChange:n,transition:"slide",autoPlay:!0,interval:4e3,size:"md"})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("h5",{className:"text-accent font-semibold",children:"Fade Transition"}),e.jsx("span",{className:"text-muted text-xs font-mono bg-surface px-2 py-1 rounded",children:"cross-fade"})]}),e.jsx("div",{className:"max-w-lg",children:e.jsx(d,{images:u,currentIndex:o,onChange:g,transition:"fade",autoPlay:!0,interval:3500,size:"md"})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("h5",{className:"text-accent font-semibold",children:"Matrix Transition"}),e.jsx("span",{className:"text-muted text-xs font-mono bg-surface px-2 py-1 rounded",children:"cyberpunk"})]}),e.jsx("div",{className:"max-w-lg",children:e.jsx(d,{images:u,currentIndex:p,onChange:x,transition:"matrix",autoPlay:!0,interval:3e3,size:"md"})})]}),e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("h5",{className:"text-accent font-semibold",children:"Signal-Glitch Transition"}),e.jsx("span",{className:"text-muted text-xs font-mono bg-surface px-2 py-1 rounded",children:"analog-error"})]}),e.jsx("div",{className:"max-w-lg",children:e.jsx(d,{images:u,currentIndex:m,onChange:y,transition:"signal-glitch",autoPlay:!0,interval:3500,size:"md",glitchRate:.7})})]})]})}},S={parameters:{docs:{story:{inline:!1,iframeHeight:600}}},render:()=>{const[a,n]=i.useState(0),[o,g]=i.useState(0),[p,x]=i.useState(0);return e.jsxs("div",{className:"flex flex-col gap-6 p-6 bg-base min-h-screen",children:[e.jsx("div",{className:"space-y-2",children:e.jsx("h4",{className:"text-secondary font-semibold text-lg",children:"Size Comparison"})}),e.jsxs("div",{className:"flex flex-col gap-8",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("h5",{className:"text-accent font-semibold",children:"Small (sm)"}),e.jsx("span",{className:"text-muted text-xs font-mono bg-surface px-2 py-1 rounded",children:"compact"})]}),e.jsx("div",{className:"max-w-sm",children:e.jsx(d,{images:u,currentIndex:a,onChange:n,size:"sm",autoPlay:!1})})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("h5",{className:"text-accent font-semibold",children:"Medium (md)"}),e.jsx("span",{className:"text-muted text-xs font-mono bg-surface px-2 py-1 rounded",children:"default"})]}),e.jsx("div",{className:"max-w-md",children:e.jsx(d,{images:u,currentIndex:o,onChange:g,size:"md",autoPlay:!1})})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx("h5",{className:"text-accent font-semibold",children:"Large (lg)"}),e.jsx("span",{className:"text-muted text-xs font-mono bg-surface px-2 py-1 rounded",children:"showcase"})]}),e.jsx("div",{className:"max-w-lg",children:e.jsx(d,{images:u,currentIndex:p,onChange:x,size:"lg",autoPlay:!1})})]})]})]})}},P=[{alt:"Neon district (asset pending)",caption:"Sector 7 Uplink"},{alt:"Corporate tower (asset pending)",caption:"Megacorp Atrium"},{alt:"Back-alley market (asset pending)",caption:"Black Market Feed"}],I={parameters:{docs:{description:{story:"Slides with no `src` render the static gradient stand-in. `fallbackStyle` defaults to `gradient`."},story:{inline:!1,iframeHeight:400}}},args:{images:P,autoPlay:!1},render:a=>{const[n,o]=i.useState(0);return e.jsx("div",{className:"flex items-center justify-center min-h-screen bg-base p-8",children:e.jsx("div",{className:"w-full max-w-2xl",children:e.jsx(d,{...a,currentIndex:n,onChange:o})})})}},k={parameters:{docs:{description:{story:'`fallbackStyle="scanline"` adds a scanline that sweeps down each stand-in. The sweep stops under `prefers-reduced-motion: reduce`.'},story:{inline:!1,iframeHeight:400}}},args:{images:P,autoPlay:!1,fallbackStyle:"scanline"},render:a=>{const[n,o]=i.useState(0);return e.jsx("div",{className:"flex items-center justify-center min-h-screen bg-base p-8",children:e.jsx("div",{className:"w-full max-w-2xl",children:e.jsx(d,{...a,currentIndex:n,onChange:o})})})}},T={parameters:{docs:{story:{inline:!1,iframeHeight:900}}},render:()=>{const[a,n]=i.useState(0),[o,g]=i.useState(0),[p,x]=i.useState(1);return e.jsxs("div",{className:"flex flex-col gap-8 p-6 bg-base min-h-screen",children:[e.jsxs("div",{className:"space-y-3",children:[e.jsx("h5",{className:"text-accent font-semibold",children:"gradient (default)"}),e.jsx("div",{className:"max-w-md",children:e.jsx(d,{images:P,currentIndex:a,onChange:n,autoPlay:!1,fallbackStyle:"gradient"})})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx("h5",{className:"text-accent font-semibold",children:"scanline"}),e.jsx("div",{className:"max-w-md",children:e.jsx(d,{images:P,currentIndex:o,onChange:g,autoPlay:!1,fallbackStyle:"scanline"})})]}),e.jsxs("div",{className:"space-y-3",children:[e.jsx("h5",{className:"text-accent font-semibold",children:"Mixed: real images and slides with no src"}),e.jsx("div",{className:"max-w-md",children:e.jsx(d,{images:[u[0],{alt:"Signal lost (asset pending)",caption:"Signal Lost"},u[1]],currentIndex:p,onChange:x,autoPlay:!1,fallbackStyle:"scanline"})})]})]})}};j.parameters={...j.parameters,docs:{...j.parameters?.docs,source:{originalSource:`{
  parameters: {
    docs: {
      story: {
        inline: false,
...
}`,...T.parameters?.docs?.source}}};const be=["Default","AllTransitions","AllSizes","FallbackGradient","FallbackScanline","AllFallbackStyles"];export{T as AllFallbackStyles,S as AllSizes,C as AllTransitions,j as Default,I as FallbackGradient,k as FallbackScanline,be as __namedExportsOrder,ve as default};
