import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as W}from"./iframe-MaQcQnv3.js";import{g as L,R as M}from"./responsive-BPH5MnMe.js";import{c as $}from"./cn-CNMN3A1O.js";import"./preload-helper-D9Z9MdNV.js";const a=({variant:I="primary",size:C="md",label:S,helperText:y,error:t,leftIcon:s,rightIcon:o,className:R="",disabled:x=!1,...w})=>{const V=W.useId(),l=w.id||V,D=["w-full","rounded-lg","bg-surface","text-default","placeholder-muted","transition-all","duration-300","focus:outline-none",x?"cursor-not-allowed opacity-60":"cursor-text"].join(" "),k=r=>L(r,M.input),q=r=>{const n=k(r);return s&&o?`pl-10 pr-10 ${n}`:s?`pl-10 pr-4 ${n}`:o?`pl-4 pr-10 ${n}`:`px-4 ${n}`},z=(r,n,U)=>n?"border-2 border-error shadow-error/30 hover:shadow-error focus:ring-2 focus:ring-error focus:shadow-error active:bg-base":U?{primary:"border-2 border-accent/20 shadow-none",secondary:"border-2 border-secondary/20 shadow-none",danger:"border-2 border-error/20 shadow-none",ghost:"border border-border-default shadow-none"}[r]:{primary:"border-2 border-accent shadow-input-accent hover:shadow-lg-accent focus:ring-2 focus:ring-accent focus:shadow-lg-accent active:bg-base",secondary:"border-2 border-secondary shadow-secondary/30 hover:shadow-secondary focus:ring-2 focus:ring-secondary focus:shadow-secondary active:bg-base",danger:"border-2 border-error shadow-error/30 hover:shadow-error focus:ring-2 focus:ring-error focus:shadow-error active:bg-base",ghost:"border border-border-default shadow-none hover:border-accent focus:ring-2 focus:ring-accent focus:border-accent active:bg-base"}[r],A=r=>({primary:"text-accent",secondary:"text-secondary",danger:"text-error",ghost:"text-muted"})[r],_=$(D,q(C),z(I,!!t,x),R),T=A(I),P=t?`${l}-error`:y?`${l}-help`:void 0;return e.jsxs("div",{className:"space-y-2",children:[S&&e.jsx("label",{htmlFor:l,className:"block text-sm font-medium text-default",children:S}),e.jsxs("div",{className:"relative",children:[s&&e.jsx("div",{className:`absolute inset-y-0 left-0 flex items-center pl-3 ${T}`,children:s}),e.jsx("input",{className:_,disabled:x,id:l,"aria-invalid":!!t,"aria-describedby":P,...w}),o&&e.jsx("div",{className:`absolute inset-y-0 right-0 flex items-center pr-3 ${T}`,children:o})]}),(y||t)&&e.jsx("div",{id:t?`${l}-error`:`${l}-help`,className:`text-xs font-mono ${t?"text-error":"text-muted"}`,children:t||y})]})};a.displayName="CyberUI.Input";a.__docgenInfo={description:`A highly customizable Cyberpunk input field with support for icons, labels, and error states.
...
<Input 
  ...
  error="Access Denied" 
  leftIcon={<LockIcon />} 
/>`,methods:[],displayName:"CyberUI.Input",props:{variant:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary' | 'danger' | 'ghost'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"},{name:"literal",value:"'danger'"},{name:"literal",value:"'ghost'"}]},description:`Visual style of the input.
...
@default 'md'`,defaultValue:{value:"'md'",computed:!1}},label:{required:!1,tsType:{name:"string"},description:"Label for the input"},helperText:{required:!1,tsType:{name:"string"},description:"Optional helper text shown below the input"},error:{required:!1,tsType:{name:"string"},description:"Error message that overrides helper text and highlights the input"},leftIcon:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Icon to render on the left side of the input"},rightIcon:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Icon to render on the right side of the input"},className:{defaultValue:{value:"''",computed:!1},required:!1},disabled:{defaultValue:{value:"false",computed:!1},required:!1}},composes:["Omit"]};const N=()=>e.jsx("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 20 20",children:e.jsx("path",{fillRule:"evenodd",d:"M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z",clipRule:"evenodd"})}),j=()=>e.jsx("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 20 20",children:e.jsx("path",{fillRule:"evenodd",d:"M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z",clipRule:"evenodd"})}),E=()=>e.jsx("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 20 20",children:e.jsx("path",{fillRule:"evenodd",d:"M5 9V7a5 5 0 0110 0v2a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2zm8-2v2H7V7a3 3 0 016 0z",clipRule:"evenodd"})}),Z={title:"Components/Input",component:a,parameters:{layout:"centered",docs:{description:{component:`A cyberpunk-themed input component with multiple variants, icon support, and smooth animations.
...
}`,...b.parameters?.docs?.source}}};const J=["Primary","Secondary","Danger","Ghost","WithLeftIcon","WithRightIcon","WithBothIcons","WithError","Disabled","AllVariants","AllStates"];export{b as AllStates,f as AllVariants,d as Danger,v as Disabled,p as Ghost,i as Primary,c as Secondary,h as WithBothIcons,g as WithError,u as WithLeftIcon,m as WithRightIcon,J as __namedExportsOrder,Z as default};
