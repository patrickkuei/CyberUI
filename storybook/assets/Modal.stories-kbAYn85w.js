import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as t}from"./iframe-C0HViC5O.js";import{r as q}from"./index-CSxViACc.js";import{B as b}from"./Button-CPWKgwae.js";import{c as _}from"./cn-CNMN3A1O.js";import"./preload-helper-PPVm8Dsz.js";import"./index-Dx8LG4ZQ.js";import"./responsive-BtH3H1ZI.js";const H={openDuration:600,closeDuration:400,crtEffects:!0},G={sm:"max-w-md",md:"max-w-lg",lg:"max-w-2xl",xl:"max-w-4xl",fullscreen:"max-w-none w-full h-full"},y=t.memo(({isOpen:a,onClose:d,title:i,children:m,footer:c,onCancel:p,onConfirm:u,cancelText:A="Cancel",confirmText:S="Confirm",confirmLoading:I=!1,showCancel:D=!0,showConfirm:B=!0,size:g="md",closeOnOverlayClick:v=!0,closeOnEscape:C=!0,animation:w,className:N="",overlayClassName:z="",showCloseButton:L=!0,onOpen:k,onCRTBootComplete:j})=>{const l=t.useMemo(()=>({...H,...w}),[w]),[r,M]=t.useState(!1),[s,x]=t.useState(!0),O=t.useRef(null),R=t.useRef(null),E=t.useRef(null),T=t.useRef(`modal-title-${Math.random().toString(36).slice(2)}`),o=t.useCallback(()=>{M(!0),setTimeout(()=>{M(!1),x(!0),d()},l.closeDuration)},[d,l.closeDuration]);t.useEffect(()=>{a&&!r&&(E.current=document.activeElement||null,x(!0),k?.(),setTimeout(()=>{x(!1),j?.(),R.current?.focus()},l.openDuration))},[a,r,k,j,l.openDuration]);const P=t.useCallback(()=>{p?.(),o()},[p,o]),$=t.useCallback(()=>{u?.(),o()},[u,o]),F=t.useCallback(n=>{v&&(n.target===O.current||n.target===n.currentTarget)&&o()},[o,v]),h=t.useCallback(n=>{C&&n.key==="Escape"&&o()},[o,C]);t.useEffect(()=>{if(a){document.addEventListener("keydown",h);const n=document.body.style.overflow,U=window.innerWidth-document.documentElement.clientWidth;return document.body.style.overflow="hidden",document.body.style.paddingRight=`${U}px`,()=>{document.removeEventListener("keydown",h),document.body.style.overflow=n,document.body.style.paddingRight="",E.current?.focus?.()}}},[a,h]);const W=t.useMemo(()=>_("relative bg-surface border-2 rounded-lg max-h-[90vh] overflow-hidden flex flex-col transform transition-all duration-300",G[g],l.crtEffects&&s?"animate-crt-power-on border-accent shadow-lg-accent":l.crtEffects&&r?"animate-crt-power-off border-accent shadow-lg-accent":r?"scale-95 opacity-0 border-accent/20":s?"scale-105 opacity-90 border-accent shadow-input-accent/50":"scale-100 opacity-100 animate-rgb-glow",N),[g,l.crtEffects,r,s,N]);return a?q.createPortal(e.jsx("div",{ref:O,className:`fixed z-50 flex items-center justify-center p-4 transition-all ease-out ${z} ${r?"bg-black/0 backdrop-blur-none opacity-0 duration-800":s?"bg-black/30 backdrop-blur-md opacity-100 duration-500":"bg-black/30 backdrop-blur-sm opacity-100 duration-300"}`,style:{top:0,left:0,width:"100vw",height:"100vh"},onClick:F,"aria-hidden":!0,children:e.jsxs("div",{ref:R,className:W,onClick:n=>n.stopPropagation(),role:"dialog","aria-modal":"true","aria-labelledby":i?T.current:void 0,tabIndex:-1,children:[L&&e.jsx("button",{onClick:o,className:`absolute top-4 right-4 text-muted hover:text-accent transition-all duration-300 z-20 rounded-full w-8 h-8 flex items-center justify-center cursor-pointer transform ${r?"scale-0 rotate-180 opacity-0":s?"scale-0 opacity-0":"scale-100 opacity-100 hover:scale-110 hover:bg-accent/10"}`,"aria-label":"Close modal",children:e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 16 16",fill:"none",className:"relative",children:e.jsx("path",{d:"M12 4L4 12M4 4L12 12",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})})}),i&&e.jsx("div",{className:`px-6 py-4 border-b border-accent/20 flex-shrink-0 transition-all duration-300 ${s?"opacity-0 translate-y-2":"opacity-100 translate-y-0"}`,children:e.jsx("h2",{id:T.current,className:"text-lg font-semibold text-primary",children:i})}),e.jsx("div",{className:`flex-1 overflow-auto p-6 transition-all duration-500 ${s?"opacity-0 translate-y-4":"opacity-100 translate-y-0"}`,children:m}),(c||p||u)&&e.jsx("div",{className:`px-6 py-4 border-t border-accent/20 flex-shrink-0 transition-all duration-300 ${s?"opacity-0 translate-y-2":"opacity-100 translate-y-0"}`,children:c||e.jsxs("div",{className:"flex flex-col-reverse sm:flex-row justify-between items-center gap-3",children:[e.jsx("span",{className:"text-muted text-xs font-mono hidden sm:block",children:"> ESC to abort"}),e.jsxs("div",{className:"flex gap-3 w-full sm:w-auto",children:[D&&p&&e.jsx(b,{variant:"ghost",size:"sm",onClick:P,className:"flex-1 sm:flex-none",children:A}),B&&u&&e.jsx(b,{variant:"primary",size:"sm",onClick:$,disabled:I,className:"flex-1 sm:flex-none",children:S})]})]})})]})}),document.body):null});y.displayName="CyberUI.Modal";const oe={title:"Components/Modal",component:y,parameters:{layout:"centered",docs:{description:{component:`A cyberpunk-themed modal dialog with CRT Power-on Effect animation, overlay backdrop, and portal rendering.
...
}`,...f.parameters?.docs?.source}}};const ne=["Default"];export{f as Default,ne as __namedExportsOrder,oe as default};
