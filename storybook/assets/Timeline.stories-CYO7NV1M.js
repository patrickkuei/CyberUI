import{j as e}from"./jsx-runtime-D_zvdyIk.js";import"./iframe-91luHy9z.js";import{g as n}from"./responsive-CYBOpSLp.js";import{c as s}from"./cn-CNMN3A1O.js";import"./preload-helper-D9Z9MdNV.js";const i=({events:d,size:t="md",className:p=""})=>{const g={sm:"w-5 h-5",md:"w-6 h-6",lg:"w-8 h-8"},v={sm:"inset-1.5",md:"inset-2",lg:"inset-2.5"},x={sm:"text-sm",md:"text-(length:--text-base)",lg:"text-lg"},f={sm:"text-xs",md:"text-sm",lg:"text-(length:--text-base)"},b={sm:"text-[10px]",md:"text-xs",lg:"text-sm"},h={sm:"gap-3",md:"gap-4",lg:"gap-5"},y={sm:"space-y-4",md:"space-y-6",lg:"space-y-8"},w=n(t,g),j=n(t,v),T=n(t,x),_=n(t,f),N=n(t,b),S=n(t,h),z=n(t,y),C=a=>{const r={success:{border:"border-success bg-success/30 shadow-[0_0_10px_var(--color-success)]",background:"border-success bg-success/30 shadow-[0_0_10px_var(--color-success)]",inner:"bg-success/60"},error:{border:"border-error bg-error/30 shadow-[0_0_10px_var(--color-error)]",background:"border-error bg-error/30 shadow-[0_0_10px_var(--color-error)]",inner:"bg-error/60"},warning:{border:"border-warning bg-warning/30 shadow-[0_0_10px_var(--color-warning)]",background:"border-warning bg-warning/30 shadow-[0_0_10px_var(--color-warning)]",inner:"bg-warning/60"},info:{border:"border-info bg-info/30 shadow-[0_0_10px_var(--color-info)]",background:"border-info bg-info/30 shadow-[0_0_10px_var(--color-info)]",inner:"bg-info/60"}};return r[a]||r.info},c="polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)";return e.jsx("div",{className:s(z,p),children:d.map((a,r)=>{const u=C(a.status);return e.jsxs("div",{className:s("flex",S,"group"),children:[e.jsxs("div",{className:"flex flex-col items-center",children:[e.jsxs("div",{className:s("relative flex-shrink-0 mt-1.5",w),children:[e.jsx("div",{className:s("absolute inset-0 border-2 transition-all duration-300",u.border),style:{clipPath:c}}),e.jsx("div",{className:s("absolute",j,u.inner),style:{clipPath:c}})]}),r<d.length-1&&e.jsx("div",{className:"w-[2px] flex-1 bg-gradient-to-b from-secondary/50 to-transparent mt-2"})]}),e.jsxs("div",{className:"flex-1 pb-6",children:[e.jsxs("div",{className:"flex items-center justify-between mb-1",children:[e.jsx("h4",{className:s("font-semibold text-default group-hover:text-secondary transition-colors",T),children:a.title}),e.jsx("span",{className:s("text-muted whitespace-nowrap ml-4",N),children:a.time})]}),a.description&&e.jsx("p",{className:s("text-muted mt-1",_),children:a.description})]})]},r)})})};i.displayName="CyberUI.Timeline";i.__docgenInfo={description:"",methods:[],displayName:"CyberUI.Timeline",props:{events:{required:!0,tsType:{name:"Array",elements:[{name:"TimelineEvent"}],raw:"TimelineEvent[]"},description:"Array of timeline events to display."},size:{required:!1,tsType:{name:"union",raw:"T | ResponsiveObject<T>",elements:[{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},{name:"signature",type:"object",raw:`{
  base?: T;
  sm?: T;
  md?: T;
  lg?: T;
...
@default 'md'`,defaultValue:{value:"'md'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional CSS classes.",defaultValue:{value:"''",computed:!1}}}};const P={title:"Components/Timeline",component:i,parameters:{layout:"padded",docs:{description:{component:`A vertical timeline component for displaying events or history with cyberpunk styling.
