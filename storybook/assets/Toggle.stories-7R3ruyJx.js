import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as n}from"./iframe-Bn34fd_r.js";import{g as V}from"./responsive-B9k3icnG.js";import{c as S}from"./cn-CNMN3A1O.js";import"./preload-helper-D9Z9MdNV.js";const a=({label:l,size:v="md",variant:k="primary",className:T="",checked:x=!1,onChange:t,disabled:r=!1,id:w,...C})=>{const z=s=>{r||t&&t(s.target.checked)},M=s=>V(s,{sm:"w-10 h-5 after:h-4 after:w-4",md:"w-14 h-7 after:h-6 after:w-6",lg:"w-16 h-8 after:h-7 after:w-7"}),L=(s,N)=>{if(N)return"bg-gray-600 peer-checked:bg-gray-500 opacity-50 cursor-not-allowed";const j={primary:"bg-gray-600 peer-checked:bg-linear-(--gradient-accent) peer-focus:ring-primary",secondary:"bg-gray-600 peer-checked:bg-secondary peer-focus:ring-secondary",accent:"bg-gray-600 peer-checked:bg-accent peer-focus:ring-accent"};return j[s]||j.primary},A=S("relative inline-flex items-center",r?"cursor-not-allowed opacity-50":"cursor-pointer"),q=S(M(v),L(k,r),"peer-focus:outline-none rounded-full peer","peer-checked:after:translate-x-full peer-checked:after:border-white","after:content-[''] after:absolute after:top-[2px] after:left-[2px]","after:bg-white after:rounded-full after:transition-all motion-reduce:after:transition-none","transition-colors duration-300"),D=S("flex items-center justify-between",l&&"space-x-3",T);return e.jsxs("div",{className:D,children:[l&&e.jsx("label",{htmlFor:w,className:`text-default font-medium ${r?"text-muted opacity-50":"cursor-pointer"}`,children:l}),e.jsxs("label",{className:A,children:[e.jsx("input",{type:"checkbox",className:"sr-only peer",checked:x,onChange:z,disabled:r,id:w,...C}),e.jsx("div",{className:q})]})]})};a.displayName="CyberUI.Toggle";a.__docgenInfo={description:`A futuristic cyberpunk-themed toggle switch with neon glow and smooth transitions.
...
<Toggle 
  ...
  checked={isDark} 
  onChange={setIsDark} 
/>`,methods:[],displayName:"CyberUI.Toggle",props:{label:{required:!1,tsType:{name:"string"},description:"Optional label text to display next to the toggle"},size:{required:!1,tsType:{name:"union",raw:"T | ResponsiveObject<T>",elements:[{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},{name:"signature",type:"object",raw:`{
  base?: T;
  sm?: T;
  md?: T;
  lg?: T;
...
@default 'primary'`,defaultValue:{value:"'primary'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Optional custom class name",defaultValue:{value:"''",computed:!1}},checked:{required:!1,tsType:{name:"boolean"},description:"Whether the toggle is currently checked",defaultValue:{value:"false",computed:!1}},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(checked: boolean) => void",signature:{arguments:[{type:{name:"boolean"},name:"checked"}],return:{name:"void"}}},description:"Callback fired when the toggle state changes"},disabled:{defaultValue:{value:"false",computed:!1},required:!1}},composes:["Omit"]};const H={title:"Components/Toggle",component:a,parameters:{layout:"centered",docs:{description:{component:`A cyberpunk-themed toggle switch component with smooth animations and neon styling.
...
}`,...f.parameters?.docs?.source}}};const I=["Primary","Secondary","Accent","Small","Medium","Large","WithoutLabel","Disabled","AllVariants","AllSizes","AllStates","SystemDemo"];export{i as Accent,b as AllSizes,y as AllStates,h as AllVariants,p as Disabled,g as Large,m as Medium,o as Primary,c as Secondary,d as Small,f as SystemDemo,u as WithoutLabel,I as __namedExportsOrder,H as default};
