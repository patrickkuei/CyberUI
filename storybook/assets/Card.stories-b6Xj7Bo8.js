import{j as e}from"./jsx-runtime-D_zvdyIk.js";import"./iframe-uXSLlJ-f.js";import{g as w,R as S}from"./responsive-Cf6DXinx.js";import"./preload-helper-D9Z9MdNV.js";const a=({variant:t="default",size:v="md",title:f,titleBorder:h=!0,children:g,className:N="",...y})=>{const C=s=>w(s,S.card),b=s=>{const x=C(v);return{default:`bg-base border border-border-default rounded-xl ${x}`,accent:`bg-surface border-2 border-accent rounded-xl shadow-input-accent/50 hover:shadow-lg-accent transition-all duration-300 transform ${x}`,small:`bg-base rounded-lg border border-border-default ${x}`}[s]},j=s=>s?"text-xl font-semibold text-secondary mb-4 border-b border-accent pb-2":"text-xl font-semibold text-secondary mb-4";return e.jsxs("div",{className:`${b(t)} ${N}`,...y,children:[f&&e.jsx("h3",{className:j(h),children:f}),g]})};a.__docgenInfo={description:"",methods:[],displayName:"Card",props:{variant:{required:!1,tsType:{name:"union",raw:"'default' | 'accent' | 'small'",elements:[{name:"literal",value:"'default'"},{name:"literal",value:"'accent'"},{name:"literal",value:"'small'"}]},description:"",defaultValue:{value:"'default'",computed:!1}},size:{required:!1,tsType:{name:"union",raw:"T | ResponsiveObject<T>",elements:[{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}]},{name:"signature",type:"object",raw:`{
  base?: T;
  sm?: T;
  md?: T;
  lg?: T;
