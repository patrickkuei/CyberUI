import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as $}from"./iframe-B4DURm2g.js";import{g as J,R as K}from"./responsive-B49x6m-V.js";import{c as O}from"./cn-CNMN3A1O.js";import{C as Q}from"./index-Dm1LNrgC.js";import"./preload-helper-PPVm8Dsz.js";const a=({label:s,size:z="md",variant:q="primary",options:A,placeholder:C,helperText:N,error:l,className:L="",disabled:n=!1,id:P,name:M,onValueChange:R,onChange:k,...D})=>{const E=t=>{k?.(t),R?.(t.target.value)},V=$.useId(),T=P||V,H=M||T,F=t=>J(t,K.input),G=(t,B,Z)=>{if(B)return"bg-base border-2 border-border-default/30 text-muted/50 cursor-not-allowed opacity-50";if(Z)return"bg-surface border-2 border-error text-default focus:ring-2 focus:ring-error focus:border-error shadow-error";const j={primary:"bg-surface border-2 border-border-default text-default focus:ring-2 focus:ring-primary focus:border-primary shadow-primary",secondary:"bg-surface border-2 border-secondary text-default focus:ring-2 focus:ring-secondary focus:border-secondary shadow-secondary/30",danger:"bg-surface border-2 border-error text-default focus:ring-2 focus:ring-error focus:border-error shadow-error/30",ghost:"bg-base border-2 border-accent/20 text-default focus:ring-2 focus:ring-accent focus:border-accent shadow-secondary"};return j[t]||j.primary},I=O("appearance-none w-full rounded-lg font-mono transition-all duration-300 focus:outline-none px-4 pr-10",F(z),G(q,n,!!l),L),_="relative w-full",W=O("block text-sm font-medium mb-2 transition-colors duration-200",n?"text-muted opacity-50":l?"text-error":"text-default"),U=O("mt-2 text-xs transition-colors duration-200",l?"text-error":"text-muted");return e.jsxs("div",{className:"w-full",children:[s&&e.jsx("label",{htmlFor:T,className:W,children:s}),e.jsxs("div",{className:_,children:[e.jsxs("select",{className:I,disabled:n,id:T,name:H,onChange:E,...D,children:[C&&e.jsx("option",{value:"",disabled:!0,children:C}),A.map(t=>e.jsx("option",{value:t.value,disabled:t.disabled,className:"bg-surface text-default",children:t.label},t.value))]}),e.jsx("div",{className:`pointer-events-none absolute inset-y-0 right-0 flex items-center px-3 ${n?"text-muted/50":l?"text-error":"text-accent"}`,children:e.jsx("svg",{className:"w-4 h-4",fill:"currentColor",viewBox:"0 0 20 20",children:e.jsx("path",{fillRule:"evenodd",d:"M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z",clipRule:"evenodd"})})})]}),(N||l)&&e.jsx("div",{className:U,children:l||N})]})};a.__docgenInfo={description:`A futuristic Cyberpunk-themed dropdown select component with support for labels and error states.
