...
Focus restoration only fires after a keyboard-driven dismissal (Escape) — a click on the overlay doesn't restore focus, since the click itself already tells the browser where focus should go.
