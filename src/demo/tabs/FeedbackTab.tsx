      ...
      <div className="bg-base border border-border-default rounded-xl p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            ...
            <div className="text-xs text-muted">Uploading neural patterns...</div>
          </div>

          <div className="flex flex-col items-center space-y-4">
            <CircularProgress progress={progress} radius={PROGRESS_CONFIG.RADIUS} className="w-20 h-20">
              <span className="text-accent font-mono text-sm">{progress}%</span>
            </CircularProgress>
            <div className="text-center">
              <div className="text-default font-medium">System Scan</div>
              <div className="text-xs text-muted mt-1">Analyzing threat vectors...</div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            <div className="text-center">
              ...
              <div className="text-xs text-muted mt-1">Monitoring segmented data flow...</div>
            </div>
          </div>
        </div>
      </div>
