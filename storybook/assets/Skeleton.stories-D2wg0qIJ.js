...
@default 'md'`,defaultValue:{value:'"md"',computed:!1}},width:{required:!1,tsType:{name:"union",raw:"string | number",elements:[{name:"string"},{name:"number"}]},description:""},height:{required:!1,tsType:{name:"union",raw:"string | number",elements:[{name:"string"},{name:"number"}]},description:""},className:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'""',computed:!1}},lines:{required:!1,tsType:{name:"number"},description:`Number of lines for text variant.
...
@default true`,defaultValue:{value:"true",computed:!1}}}};const I={title:"Components/Skeleton",component:r,parameters:{layout:"centered",docs:{description:{component:`A cyberpunk-themed skeleton loader component for displaying loading placeholders with smooth animations.
...
}`,...w.parameters?.docs?.source}}};const P=["Text","Circular","Rectangular","AvatarText","ButtonGroup","Card","Small","Medium","Large","WithoutAnimation","CustomDimensions","AllVariants","AllSizes","LoadingStates","CyberpunkDemo"];export{S as AllSizes,j as AllVariants,x as AvatarText,v as ButtonGroup,p as Card,c as Circular,f as CustomDimensions,w as CyberpunkDemo,N as Large,y as LoadingStates,g as Medium,u as Rectangular,h as Small,m as Text,b as WithoutAnimation,P as __namedExportsOrder,I as default};
