import{j as e}from"./jsx-runtime-D_zvdyIk.js";import"./iframe-mP1eHMDB.js";import{g as w,R as S}from"./responsive-Cmibuo0E.js";import{c as T}from"./cn-CNMN3A1O.js";import"./preload-helper-D9Z9MdNV.js";const a=({variant:t="default",size:v="md",title:x,titleBorder:h=!0,children:g,className:N="",...y})=>{const C=s=>w(s,S.card),b=s=>{const f=C(v);return{default:`bg-base border border-border-default rounded-xl text-primary ${f}`,accent:`bg-surface border-2 border-accent rounded-xl shadow-input-accent/50 hover:shadow-lg-accent transition-all duration-300 transform text-primary ${f}`,small:`bg-base rounded-lg border border-border-default text-primary ${f}`}[s]},j=s=>s?"text-xl font-semibold text-secondary mb-4 border-b border-accent pb-2":"text-xl font-semibold text-secondary mb-4";return e.jsxs("div",{className:T(b(t),N),...y,children:[x&&e.jsx("h3",{className:j(h),children:x}),g]})};a.displayName="CyberUI.Card";a.__docgenInfo={description:`A cyberpunk-themed container with glassmorphism, neon borders, and responsive spacing.
...
<Card size={{ base: 'sm', lg: 'lg' }}>
  ...
  xl?: T;
  "2xl"?: T;
}`,signature:{properties:[{key:"base",value:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}],required:!1}},{key:"sm",value:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}],required:!1}},{key:"md",value:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}],required:!1}},{key:"lg",value:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}],required:!1}},{key:"xl",value:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}],required:!1}},{key:"2xl",value:{name:"union",raw:"'sm' | 'md' | 'lg'",elements:[{name:"literal",value:"'sm'"},{name:"literal",value:"'md'"},{name:"literal",value:"'lg'"}],required:!1}}]}}]},description:`Padding size of the card content.
@default 'md'`,defaultValue:{value:"'md'",computed:!1}},title:{required:!1,tsType:{name:"string"},description:"Optional title for the card"},titleBorder:{required:!1,tsType:{name:"boolean"},description:`Whether to show a border under the title.
@default true`,defaultValue:{value:"true",computed:!1}},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"The content to be rendered inside the card"},className:{defaultValue:{value:"''",computed:!1},required:!1}},composes:["Omit"]};const I=()=>e.jsx("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 20 20",children:e.jsx("path",{fillRule:"evenodd",d:"M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z",clipRule:"evenodd"})}),z=()=>e.jsx("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 20 20",children:e.jsx("path",{d:"M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"})}),k=()=>e.jsxs("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 20 20",children:[e.jsx("path",{d:"M3 12v3c0 1.657 3.134 3 7 3s7-1.343 7-3v-3c0 1.657-3.134 3-7 3s-7-1.343-7-3z"}),e.jsx("path",{d:"M3 7v3c0 1.657 3.134 3 7 3s7-1.343 7-3V7c0 1.657-3.134 3-7 3S3 8.657 3 7z"}),e.jsx("path",{d:"M17 5c0 1.657-3.134 3-7 3S3 6.657 3 5s3.134-3 7-3 7 1.343 7 3z"})]}),P={title:"Components/Card",component:a,parameters:{layout:"centered",docs:{description:{component:`A cyberpunk-themed card component with multiple variants and customizable styling.
...
`}}},tags:["autodocs"],argTypes:{variant:{control:{type:"select"},options:["default","accent","small"],description:"Card style variant"},size:{control:{type:"select"},options:["sm","md","lg"],description:"Card size (supports responsive values)"},title:{control:"text",description:"Card title text"},titleBorder:{control:"boolean",description:"Whether to show border under title"},className:{control:"text",description:"Additional CSS classes"}}},r={render:t=>e.jsx(a,{...t,children:e.jsx("p",{className:"text-default",children:"This is a default card with standard cyberpunk styling. Perfect for main content sections and general information display."})}),args:{variant:"default"}},n={render:t=>e.jsx(a,{...t,children:e.jsx("p",{className:"text-default",children:"This is an accent card with enhanced visual emphasis and hover effects. Use for interactive or important content that needs to stand out."})}),args:{variant:"accent"}},l={render:t=>e.jsx(a,{...t,children:e.jsx("p",{className:"text-default",children:"Compact card variant designed for metrics, status indicators, or secondary information that needs minimal space."})}),args:{variant:"small"}},i={render:t=>e.jsx(a,{...t,children:e.jsx("p",{className:"text-default",children:"System operational and ready for neural link commands. All subsystems are functioning within normal parameters."})}),args:{title:"Neural Interface Status"}},d={render:t=>e.jsx(a,{...t,children:e.jsx("p",{className:"text-default",children:"This card has a title without the bottom border for a cleaner, more minimal appearance."})}),args:{title:"Clean Interface",titleBorder:!1}},c={render:t=>e.jsx(a,{...t,children:e.jsx("p",{className:"text-default",children:"Enhanced accent card with title. Features hover effects and visual emphasis for important interactive content."})}),args:{variant:"accent",title:"Interactive Dashboard"}},o={render:t=>e.jsx(a,{...t,children:e.jsx("p",{className:"text-default",children:"Compact card with title, perfect for displaying key metrics or status information in a minimal space."})}),args:{variant:"small",title:"Metric"}},m={render:()=>e.jsx(a,{title:"System Status",className:"w-80",children:e.jsxs("div",{className:"space-y-4",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:"text-primary",children:e.jsx(I,{})}),e.jsx("span",{className:"text-default",children:"Security Level"})]}),e.jsx("span",{className:"text-primary font-mono font-bold",children:"MAXIMUM"})]}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:"text-secondary",children:e.jsx(z,{})}),e.jsx("span",{className:"text-default",children:"Neural Processor"})]}),e.jsx("span",{className:"text-secondary font-mono",children:"ONLINE"})]}),e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("div",{className:"text-accent",children:e.jsx(k,{})}),e.jsx("span",{className:"text-default",children:"Data Integrity"})]}),e.jsx("span",{className:"text-primary font-mono",children:"98.7%"})]})]})})},p={render:()=>e.jsxs("div",{className:"flex flex-col gap-6 p-6 bg-base min-w-96",children:[e.jsx("h4",{className:"text-secondary font-semibold",children:"Card Variants"}),e.jsx(a,{title:"Default Card",children:e.jsx("p",{className:"text-default",children:"Standard card styling with neutral background and basic border. Perfect for general content and information display."})}),e.jsx(a,{variant:"accent",title:"Accent Card",children:e.jsx("p",{className:"text-default",children:"Enhanced card with accent border, shadow effects, and hover animations. Use for interactive or highlighted content."})}),e.jsx(a,{variant:"small",title:"Small Card",children:e.jsx("p",{className:"text-default",children:"Compact variant with reduced padding and smaller dimensions. Ideal for metrics, status indicators, or secondary info."})})]})},u={render:()=>e.jsxs(a,{title:"Cyberpunk Dashboard",className:"w-96",children:[e.jsx("p",{className:"text-default mb-6",children:"Neural interface control panel with system metrics and nested components:"}),e.jsxs("div",{className:"space-y-4",children:[e.jsx(a,{variant:"accent",title:"Connection Status",titleBorder:!1,children:e.jsxs("div",{className:"text-center space-y-2",children:[e.jsx("div",{className:"text-lg font-semibold text-default",children:"Neural Link"}),e.jsx("div",{className:"text-primary font-mono text-xl",children:"CONNECTED"}),e.jsx("div",{className:"text-xs text-muted",children:"Latency: 0.3ms"})]})}),e.jsxs("div",{className:"grid grid-cols-2 gap-3",children:[e.jsx(a,{variant:"small",children:e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"text-primary font-mono font-bold text-2xl",children:"98%"}),e.jsx("div",{className:"text-muted text-xs",children:"CPU Usage"})]})}),e.jsx(a,{variant:"small",children:e.jsxs("div",{className:"text-center",children:[e.jsx("div",{className:"text-secondary font-mono font-bold text-2xl",children:"2.1GB"}),e.jsx("div",{className:"text-muted text-xs",children:"Memory"})]})})]})]})]})};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
...
}`,...u.parameters?.docs?.source}}};const U=["Default","Accent","Small","WithTitle","WithTitleNoBorder","AccentWithTitle","SmallWithTitle","SystemStatus","AllVariants","DashboardExample"];export{n as Accent,c as AccentWithTitle,p as AllVariants,u as DashboardExample,r as Default,l as Small,o as SmallWithTitle,m as SystemStatus,i as WithTitle,d as WithTitleNoBorder,U as __namedExportsOrder,P as default};
