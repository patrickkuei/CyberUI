...
Escape or an outside click closes the calendar; only Escape restores focus to the trigger — an outside click doesn't, since the click already told the browser where focus should go.
