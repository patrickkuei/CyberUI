import{j as e}from"./jsx-runtime-D_zvdyIk.js";import"./iframe-3mlU2Cen.js";import{c as v}from"./cn-CNMN3A1O.js";import"./preload-helper-D9Z9MdNV.js";const t=({variant:a="gradient",orientation:d="horizontal",className:c=""})=>{const m=o=>o==="horizontal"?"w-full h-[1px]":"w-[1px] h-full",p=(o,l)=>({gradient:l==="horizontal"?"bg-gradient-to-r from-transparent via-secondary/50 to-transparent":"bg-gradient-to-b from-transparent via-secondary/50 to-transparent",solid:"bg-secondary/30",dashed:`border-dashed border-secondary/50 ${l==="horizontal"?"border-t":"border-l"}`})[o],u=v(m(d),p(a,d),c);return e.jsx("div",{className:u})};t.displayName="CyberUI.Divider";t.__docgenInfo={description:"",methods:[],displayName:"CyberUI.Divider",props:{variant:{required:!1,tsType:{name:"union",raw:"'gradient' | 'solid' | 'dashed'",elements:[{name:"literal",value:"'gradient'"},{name:"literal",value:"'solid'"},{name:"literal",value:"'dashed'"}]},description:"Visual style of the divider.\n- `gradient`: Gradient fade from center (default).\n- `solid`: Solid semi-transparent line.\n- `dashed`: Dashed border style.\n@default 'gradient'",defaultValue:{value:"'gradient'",computed:!1}},orientation:{required:!1,tsType:{name:"union",raw:"'horizontal' | 'vertical'",elements:[{name:"literal",value:"'horizontal'"},{name:"literal",value:"'vertical'"}]},description:`Orientation of the divider.
@default 'horizontal'`,defaultValue:{value:"'horizontal'",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional CSS classes.",defaultValue:{value:"''",computed:!1}}}};const N={title:"Components/Divider",component:t,parameters:{layout:"padded",docs:{description:{component:`A flexible divider component for separating content with cyberpunk styling.
...
}`,...n.parameters?.docs?.source}}};const b=["GradientHorizontal","SolidHorizontal","DashedHorizontal","Vertical"];export{i as DashedHorizontal,r as GradientHorizontal,s as SolidHorizontal,n as Vertical,b as __namedExportsOrder,N as default};
