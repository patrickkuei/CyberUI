          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between bg-surface border border-border-default rounded-lg p-3">
                ...
                <span className="text-xs text-secondary font-mono">STANDBY</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                <div className="h-48">
                  <Image src="image_demo_1.jpg" alt="Cyberpunk cityscape with neon lights reflecting on wet streets" size="md" className="h-full object-cover" />
                </div>
              ...
              <div className="space-y-2">
                <div className="h-48">
                  <Image src="image_demo_3.jpg" alt="Holographic display showing system diagnostics" size="md" className="h-full object-cover" />
                </div>
                <p className="text-xs text-muted text-center">System Diagnostics</p>
              </div>

              <div className="space-y-2">
                <div className="h-48">
                  <Image src="noexist.jpg" alt="Futuristic neural network interface with data streams" size="md" className="h-full object-cover" />
                </div>
                <p className="text-xs text-muted text-center">Neural Interface Offline</p>
              </div>
            </div>
          </div>
        </div>
