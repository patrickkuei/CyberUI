...
@default 3`,defaultValue:{value:"3",computed:!1}},animate:{required:!1,tsType:{name:"boolean"},description:`Whether to show the pulse animation. The pulse stays off while the user prefers reduced motion.
@default true`,defaultValue:{value:"true",computed:!1}}}};const U={title:"Components/Skeleton",component:s,parameters:{layout:"centered",docs:{description:{component:`A cyberpunk-themed skeleton loader component for displaying loading placeholders with smooth animations.
...
}`,...w.parameters?.docs?.source}}};const _=["Text","Circular","Rectangular","AvatarText","ButtonGroup","Card","Small","Medium","Large","WithoutAnimation","CustomDimensions","AllVariants","AllSizes","LoadingStates","CyberpunkDemo"];export{S as AllSizes,j as AllVariants,x as AvatarText,v as ButtonGroup,p as Card,c as Circular,N as CustomDimensions,w as CyberpunkDemo,f as Large,y as LoadingStates,g as Medium,u as Rectangular,h as Small,m as Text,b as WithoutAnimation,_ as __namedExportsOrder,U as default};
