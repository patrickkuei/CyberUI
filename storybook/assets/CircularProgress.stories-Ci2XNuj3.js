import{j as e}from"./jsx-runtime-u17CrQMm.js";import"./iframe-B52jae2o.js";import"./preload-helper-PPVm8Dsz.js";const p=({progress:c,radius:i,className:d="",children:l,ariaLabel:m})=>{const n=2*Math.PI*i,r=n/2,u=r*(1-c/100),g=r*(1-c/100);return e.jsxs("div",{className:`relative ${d}`,role:"progressbar","aria-label":m||"Progress","aria-valuenow":Math.max(0,Math.min(100,c)),"aria-valuemin":0,"aria-valuemax":100,children:[e.jsxs("svg",{className:"w-full h-full overflow-visible",viewBox:"0 0 50 50",children:[e.jsx("circle",{cx:"25",cy:"25",r:i,fill:"none",stroke:"var(--color-accent)",strokeWidth:"4",strokeLinecap:"butt",strokeDasharray:`${r*.98} ${n}`,strokeDashoffset:u,transform:"rotate(-90 25 25)",style:{filter:"drop-shadow(0 0 8px var(--color-accent))"}}),e.jsx("circle",{cx:"25",cy:"25",r:i,fill:"none",stroke:"var(--color-primary)",strokeWidth:"4",strokeLinecap:"butt",strokeDasharray:`${r*.98} ${n}`,strokeDashoffset:g,transform:"rotate(90 25 25)",style:{filter:"drop-shadow(0 0 8px var(--color-primary))"}})]}),l&&e.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:l})]})};p.__docgenInfo={description:"",methods:[],displayName:"CircularProgress",props:{progress:{required:!0,tsType:{name:"number"},description:"Progress value (0-100)."},radius:{required:!0,tsType:{name:"number"},description:"Radius of the circle in pixels."},className:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:"''",computed:!1}},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},ariaLabel:{required:!1,tsType:{name:"string"},description:""}}};const y={title:"Components/CircularProgress",component:p,parameters:{layout:"centered",docs:{description:{component:`A cyberpunk-themed circular progress indicator with neon styling and smooth animations.
...
}`,...o.parameters?.docs?.source}}};const N=["Default","WithText","Small","Large"];export{s as Default,o as Large,t as Small,a as WithText,N as __namedExportsOrder,y as default};
