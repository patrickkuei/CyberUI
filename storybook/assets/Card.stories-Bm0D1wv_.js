import{j as e}from"./jsx-runtime-u17CrQMm.js";import"./iframe-C0HViC5O.js";import{g as w,R as S}from"./responsive-BtH3H1ZI.js";import{c as T}from"./cn-CNMN3A1O.js";import"./preload-helper-PPVm8Dsz.js";const a=({variant:t="default",size:v="md",title:x,titleBorder:h=!0,children:g,className:N="",...y})=>{const C=s=>w(s,S.card),b=s=>{const f=C(v);return{default:`bg-base border border-border-default rounded-xl ${f}`,accent:`bg-surface border-2 border-accent rounded-xl shadow-input-accent/50 hover:shadow-lg-accent transition-all duration-300 transform ${f}`,small:`bg-base rounded-lg border border-border-default ${f}`}[s]},j=s=>s?"text-xl font-semibold text-secondary mb-4 border-b border-accent pb-2":"text-xl font-semibold text-secondary mb-4";return e.jsxs("div",{className:T(b(t),N),...y,children:[x&&e.jsx("h3",{className:j(h),children:x}),g]})};a.__docgenInfo={description:`A cyberpunk-themed container with glassmorphism, neon borders, and responsive spacing.
...
@default true`,defaultValue:{value:"true",computed:!1}},children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"The content to be rendered inside the card"},className:{required:!1,tsType:{name:"string"},description:"Optional custom class name",defaultValue:{value:"''",computed:!1}}}};const z=()=>e.jsx("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 20 20",children:e.jsx("path",{fillRule:"evenodd",d:"M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z",clipRule:"evenodd"})}),I=()=>e.jsx("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 20 20",children:e.jsx("path",{d:"M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z"})}),k=()=>e.jsxs("svg",{className:"w-5 h-5",fill:"currentColor",viewBox:"0 0 20 20",children:[e.jsx("path",{d:"M3 12v3c0 1.657 3.134 3 7 3s7-1.343 7-3v-3c0 1.657-3.134 3-7 3s-7-1.343-7-3z"}),e.jsx("path",{d:"M3 7v3c0 1.657 3.134 3 7 3s7-1.343 7-3V7c0 1.657-3.134 3-7 3S3 8.657 3 7z"}),e.jsx("path",{d:"M17 5c0 1.657-3.134 3-7 3S3 6.657 3 5s3.134-3 7-3 7 1.343 7 3z"})]}),P={title:"Components/Card",component:a,parameters:{layout:"centered",docs:{description:{component:`A cyberpunk-themed card component with multiple variants and customizable styling.
...
}`,...u.parameters?.docs?.source}}};const V=["Default","Accent","Small","WithTitle","WithTitleNoBorder","AccentWithTitle","SmallWithTitle","SystemStatus","AllVariants","DashboardExample"];export{n as Accent,c as AccentWithTitle,p as AllVariants,u as DashboardExample,r as Default,l as Small,o as SmallWithTitle,m as SystemStatus,i as WithTitle,d as WithTitleNoBorder,V as __namedExportsOrder,P as default};
