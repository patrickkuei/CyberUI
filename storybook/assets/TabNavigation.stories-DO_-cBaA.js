import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as n}from"./iframe-mP1eHMDB.js";import{u as z,g as B,R as M}from"./responsive-Cmibuo0E.js";import{D as d}from"./index-Dm1LNrgC.js";import"./preload-helper-D9Z9MdNV.js";const $=({tabs:a,activeTab:i,onTabChange:h,sizeClasses:j,containerClassName:A="",anchorClassName:p="",menuClassName:S="",menuItemClassName:I="",dropdownLabel:b,anchorIcon:D,showAnchorLabel:y=!0,anchorAriaLabel:O,closeOnSelect:q=!0})=>{const[r,u]=n.useState(!1),[H,g]=n.useState(!1),[m,l]=n.useState(!1),[v,o]=n.useState(!1),k=n.useRef(null),E=n.useRef(null),t=n.useRef(null),f=n.useRef(null);n.useEffect(()=>()=>{t.current&&clearTimeout(t.current),f.current&&clearTimeout(f.current)},[]),n.useEffect(()=>{if(!r)return;const s=V=>{k.current&&!k.current.contains(V.target)&&(l(!0),t.current&&clearTimeout(t.current),t.current=setTimeout(()=>{u(!1),l(!1)},180))};return document.addEventListener("mousedown",s),()=>document.removeEventListener("mousedown",s)},[r]),n.useEffect(()=>{if(!r)return;const s=E.current;if(!s)return;const V=s.getBoundingClientRect();o(V.right>window.innerWidth)},[r]);const L=()=>{r?(l(!0),t.current&&clearTimeout(t.current),t.current=setTimeout(()=>{u(!1),l(!1)},180)):(g(!0),u(!0),f.current&&clearTimeout(f.current),f.current=setTimeout(()=>g(!1),30))};return e.jsx("div",{className:`${A}`,children:e.jsxs("div",{ref:k,className:"relative inline-block",children:[e.jsxs("button",{onClick:L,className:`inline-flex items-center gap-2 ${j} bg-surface text-default border-2 border-border-default rounded-lg transition-all duration-300 hover:text-secondary hover:border-secondary hover:cursor-pointer shadow-secondary/30 ${p}`,"aria-haspopup":"menu","aria-expanded":r,"aria-label":y?void 0:O??(typeof b=="string"?b:"Open tabs"),children:[D??e.jsxs("svg",{className:"w-5 h-5",viewBox:"0 0 20 20",fill:"currentColor","aria-hidden":"true",children:[e.jsx("rect",{x:"3",y:"5",width:"14",height:"2",rx:"1"}),e.jsx("rect",{x:"3",y:"9",width:"14",height:"2",rx:"1"}),e.jsx("rect",{x:"3",y:"13",width:"14",height:"2",rx:"1"})]}),y&&e.jsx("span",{children:b??i})]}),(r||m)&&e.jsx("div",{ref:E,"aria-hidden":!r,className:`absolute ${v?"right-0":"left-0"} mt-2 min-w-40 z-50 bg-surface border-2 border-border-default rounded-lg shadow-secondary overflow-hidden ${S}
              transition-transform transition-opacity duration-200 ease-[cubic-bezier(.2,0,0,1)] transform-gpu origin-top will-change-transform will-change-opacity ${H||m?"opacity-0 scale-y-0 pointer-events-none":"opacity-100 scale-y-100 pointer-events-auto"}`,children:e.jsx("div",{className:"py-1",children:a.map(s=>e.jsx("button",{onClick:()=>{h(s),q&&(l(!0),t.current&&clearTimeout(t.current),t.current=setTimeout(()=>{u(!1),l(!1)},180))},className:`w-full flex items-center justify-between text-left px-4 py-2 font-bold transition-colors duration-200 outline-none hover:cursor-pointer ${i===s?"text-secondary relative pl-4 before:content-[''] before:h-full before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:h-4 before:w-[3px] before:rounded before:bg-accent before:shadow-lg-accent":"text-default hover:text-secondary hover:bg-base/70"} ${I}`,children:e.jsx("span",{children:s})},s))})})]})})},c=({tabs:a,activeTab:i,onTabChange:h,size:j="md",mode:A="scroll",containerClassName:p="",tabsClassName:S="",dropdownLabel:I,anchorIcon:b,showAnchorLabel:D=!0,anchorAriaLabel:y,closeOnSelect:O=!0,anchorClassName:q="",menuClassName:r="",menuItemClassName:u=""})=>{const g=(o=>B(o,M.tabNavigation))(j),m=z(A,"scroll"),l=()=>{switch(m){case"scroll":return"w-full overflow-x-auto overflow-y-hidden scrollbar-thin scrollbar-thumb-border-default scrollbar-track-transparent hover:scrollbar-thumb-secondary/50 py-1";case"wrap":return"flex flex-wrap gap-2";case"dropdown":case"collapsible":return"flex space-x-2";default:return"flex space-x-2"}},v=e.jsx(e.Fragment,{children:a.map(o=>e.jsx("button",{onClick:()=>h(o),className:`
            ${g} font-bold transition-colors duration-200 rounded-t-lg cursor-pointer whitespace-nowrap flex-shrink-0 relative
            ...
            ${i===o?"text-secondary after:bg-linear-(--gradient-accent) after:shadow-lg-accent after:scale-x-100":"text-muted hover:text-secondary hover:before:opacity-70"}
            ${S}
          `,role:"tab","aria-selected":i===o,tabIndex:i===o?0:-1,children:o},o))});return m==="dropdown"?e.jsx($,{tabs:a,activeTab:i,onTabChange:h,sizeClasses:g,containerClassName:p,anchorClassName:q,menuClassName:r,menuItemClassName:u,dropdownLabel:I,anchorIcon:b,showAnchorLabel:D,anchorAriaLabel:y,closeOnSelect:O}):m==="scroll"?e.jsx("div",{className:`${l()} ${p}`,role:"tablist","aria-label":"Tabs",children:e.jsx("div",{className:"w-max mx-auto flex space-x-2",children:v})}):e.jsx("div",{className:`${l()} ${p}`,role:"tablist","aria-label":"Tabs",children:v})};c.displayName="CyberUI.TabNavigation";c.__docgenInfo={description:`A highly adaptive tabbed navigation system with cyberpunk animations and multiple layout modes.
...
}`,...N.parameters?.docs?.source}}};const Y=["Default","DropdownMode","ResponsiveModes","DropdownCustomLabel","DropdownCustomIcon","DropdownIconOnly"];export{w as Default,R as DropdownCustomIcon,C as DropdownCustomLabel,N as DropdownIconOnly,T as DropdownMode,x as ResponsiveModes,Y as __namedExportsOrder,K as default};
