import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as s}from"./iframe-MaQcQnv3.js";import{u as L,g as E,R as z}from"./responsive-BPH5MnMe.js";import{D as i}from"./index-Dm1LNrgC.js";import"./preload-helper-D9Z9MdNV.js";const B=({tabs:a,activeTab:l,onTabChange:g,sizeClasses:R,containerClassName:N="",anchorClassName:u="",menuClassName:j="",menuItemClassName:A="",dropdownLabel:p,anchorIcon:S,showAnchorLabel:f=!0,anchorAriaLabel:I,closeOnSelect:D=!0})=>{const[t,c]=s.useState(!1),[k,b]=s.useState(!1),[m,r]=s.useState(!1),[h,n]=s.useState(!1),O=s.useRef(null),V=s.useRef(null);s.useEffect(()=>{if(!t)return;const o=q=>{O.current&&!O.current.contains(q.target)&&(r(!0),setTimeout(()=>{c(!1),r(!1)},180))};return document.addEventListener("mousedown",o),()=>document.removeEventListener("mousedown",o)},[t]),s.useEffect(()=>{if(!t)return;const o=V.current;if(!o)return;const q=o.getBoundingClientRect();n(q.right>window.innerWidth)},[t]);const H=()=>{t?(r(!0),setTimeout(()=>{c(!1),r(!1)},180)):(b(!0),c(!0),setTimeout(()=>b(!1),30))};return e.jsx("div",{className:`${N}`,children:e.jsxs("div",{ref:O,className:"relative inline-block",children:[e.jsxs("button",{onClick:H,className:`inline-flex items-center gap-2 ${R} bg-surface text-default border-2 border-border-default rounded-lg transition-all duration-300 hover:text-secondary hover:border-secondary hover:cursor-pointer shadow-secondary/30 ${u}`,"aria-haspopup":"menu","aria-expanded":t,"aria-label":f?void 0:I??(typeof p=="string"?p:"Open tabs"),children:[S??e.jsxs("svg",{className:"w-5 h-5",viewBox:"0 0 20 20",fill:"currentColor","aria-hidden":"true",children:[e.jsx("rect",{x:"3",y:"5",width:"14",height:"2",rx:"1"}),e.jsx("rect",{x:"3",y:"9",width:"14",height:"2",rx:"1"}),e.jsx("rect",{x:"3",y:"13",width:"14",height:"2",rx:"1"})]}),f&&e.jsx("span",{children:p??l})]}),(t||m)&&e.jsx("div",{ref:V,"aria-hidden":!t,className:`absolute ${h?"right-0":"left-0"} mt-2 min-w-40 z-50 bg-surface border-2 border-border-default rounded-lg shadow-secondary overflow-hidden ${j}
              transition-transform transition-opacity duration-200 ease-[cubic-bezier(.2,0,0,1)] transform-gpu origin-top will-change-transform will-change-opacity ${k||m?"opacity-0 scale-y-0 pointer-events-none":"opacity-100 scale-y-100 pointer-events-auto"}`,children:e.jsx("div",{className:"py-1",children:a.map(o=>e.jsx("button",{onClick:()=>{g(o),D&&(r(!0),setTimeout(()=>{c(!1),r(!1)},180))},className:`w-full flex items-center justify-between text-left px-4 py-2 font-bold transition-colors duration-200 outline-none hover:cursor-pointer ${l===o?"text-secondary relative pl-4 before:content-[''] before:h-full before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:h-4 before:w-[3px] before:rounded before:bg-accent before:shadow-lg-accent":"text-default hover:text-secondary hover:bg-base/70"} ${A}`,children:e.jsx("span",{children:o})},o))})})]})})},d=({tabs:a,activeTab:l,onTabChange:g,size:R="md",mode:N="scroll",containerClassName:u="",tabsClassName:j="",dropdownLabel:A,anchorIcon:p,showAnchorLabel:S=!0,anchorAriaLabel:f,closeOnSelect:I=!0,anchorClassName:D="",menuClassName:t="",menuItemClassName:c=""})=>{const b=(n=>E(n,z.tabNavigation))(R),m=L(N,"scroll"),r=()=>{switch(m){case"scroll":return"w-full overflow-x-auto overflow-y-hidden scrollbar-thin scrollbar-thumb-border-default scrollbar-track-transparent hover:scrollbar-thumb-secondary/50 py-1";case"wrap":return"flex flex-wrap gap-2";case"dropdown":case"collapsible":return"flex space-x-2";default:return"flex space-x-2"}},h=e.jsx(e.Fragment,{children:a.map(n=>e.jsx("button",{onClick:()=>g(n),className:`
            ...
            ${j}
          `,role:"tab","aria-selected":l===n,tabIndex:l===n?0:-1,children:n},n))});return m==="dropdown"?e.jsx(B,{tabs:a,activeTab:l,onTabChange:g,sizeClasses:b,containerClassName:u,anchorClassName:D,menuClassName:t,menuItemClassName:c,dropdownLabel:A,anchorIcon:p,showAnchorLabel:S,anchorAriaLabel:f,closeOnSelect:I}):m==="scroll"?e.jsx("div",{className:`${r()} ${u}`,role:"tablist","aria-label":"Tabs",children:e.jsx("div",{className:"w-max mx-auto flex space-x-2",children:h})}):e.jsx("div",{className:`${r()} ${u}`,role:"tablist","aria-label":"Tabs",children:h})};d.displayName="CyberUI.TabNavigation";d.__docgenInfo={description:`A highly adaptive tabbed navigation system with cyberpunk animations and multiple layout modes.
...
}`,...C.parameters?.docs?.source}}};const F=["Default","DropdownMode","ResponsiveModes","DropdownCustomLabel","DropdownCustomIcon","DropdownIconOnly"];export{y as Default,x as DropdownCustomIcon,T as DropdownCustomLabel,C as DropdownIconOnly,v as DropdownMode,w as ResponsiveModes,F as __namedExportsOrder,U as default};
