import{j as t}from"./jsx-runtime-u17CrQMm.js";import"./iframe-C0HViC5O.js";import{c as L}from"./cn-CNMN3A1O.js";import{P as $}from"./index-Dm1LNrgC.js";import"./preload-helper-PPVm8Dsz.js";const M=({progress:P,className:w="",children:f})=>{const{SEGMENT_COUNT:R,SEGMENT_ANGLE:y,GAP_ANGLE:v,INNER_RADIUS:o,OUTER_RADIUS:n,OUTER_TICK_RADIUS:c}=$,b=y-v;return t.jsxs("div",{className:L("relative",w),children:[t.jsxs("svg",{className:"w-full h-full",viewBox:"0 0 60 60",style:{overflow:"visible"},children:[[...Array(60)].map((E,r)=>{const s=6*r,e=r%5===0?6:3,g="var(--color-muted)",h=30+c*Math.cos(s*Math.PI/180),u=30+c*Math.sin(s*Math.PI/180),x=30+(c-e)*Math.cos(s*Math.PI/180),N=30+(c-e)*Math.sin(s*Math.PI/180);return t.jsx("line",{x1:h,y1:u,x2:x,y2:N,stroke:g,strokeWidth:1,strokeLinecap:"round",opacity:.7},`tick-${r}`)}),[...Array(R)].map((E,r)=>{const s=y*r-90+v/2,a=s+b,e=I=>I*Math.PI/180,g=30+o*Math.cos(e(s)),h=30+o*Math.sin(e(s)),u=30+n*Math.cos(e(s)),x=30+n*Math.sin(e(s)),N=30+n*Math.cos(e(a)),T=30+n*Math.sin(e(a)),A=30+o*Math.cos(e(a)),_=30+o*Math.sin(e(a)),j=`M ${g} ${h} L ${u} ${x} L ${N} ${T} L ${A} ${_} Z`,S=r<Math.floor(P/5);return t.jsx("path",{d:j,fill:S?"var(--color-accent)":"var(--color-border-default)",style:{filter:S?"drop-shadow(0 0 6px var(--color-accent))":"none",transition:"fill 0.3s ease"}},`segment-${r}`)})]}),f&&t.jsx("div",{className:"absolute inset-0 flex items-center justify-center",children:f})]})};M.__docgenInfo={description:`A highly technical, segmented radial progress indicator reminiscent of radar or power gauges.

@example
<SegmentedProgress progress={45}>
  <div className="text-primary font-bold">LVL 4</div>
</SegmentedProgress>`,methods:[],displayName:"SegmentedProgress",props:{progress:{required:!0,tsType:{name:"number"},description:"Progress value (0-100)."},className:{required:!1,tsType:{name:"string"},description:"Optional custom class name",defaultValue:{value:"''",computed:!1}},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"Optional content to render in the center of the segments"}}};const G={title:"Components/SegmentedProgress",component:M,parameters:{layout:"centered",docs:{description:{component:`A cyberpunk-themed segmented progress bar with neon styling and smooth animations. Uses a fixed 20-segment circular design.
...
}`,...p.parameters?.docs?.source}}};const W=["Default","WithText","Empty","Full","Large"];export{i as Default,m as Empty,d as Full,p as Large,l as WithText,W as __namedExportsOrder,G as default};
