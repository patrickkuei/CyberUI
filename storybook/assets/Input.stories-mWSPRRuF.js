import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as L}from"./iframe-BQ2vS_X5.js";import{g as M,R as $}from"./responsive-Cl9wjO7G.js";import{c as H}from"./cn-CNMN3A1O.js";import"./preload-helper-PPVm8Dsz.js";const a=({variant:I="primary",size:R="md",label:S,helperText:y,error:t,leftIcon:s,rightIcon:o,className:C="",disabled:x=!1,...w})=>{const V=L.useId(),l=w.id||V,D=["w-full","rounded-lg","bg-surface","text-default","placeholder-muted","transition-all","duration-300","focus:outline-none",x?"cursor-not-allowed opacity-60":"cursor-text"].join(" "),k=r=>M(r,$.input),q=r=>{const n=k(r);return s&&o?`pl-10 pr-10 ${n}`:s?`pl-10 pr-4 ${n}`:o?`pl-4 pr-10 ${n}`:`px-4 ${n}`},z=(r,n,W)=>n?"border-2 border-error shadow-error/30 hover:shadow-error focus:ring-2 focus:ring-error focus:shadow-error active:bg-base":W?{primary:"border-2 border-accent/20 shadow-none",secondary:"border-2 border-secondary/20 shadow-none",danger:"border-2 border-error/20 shadow-none",ghost:"border border-border-default shadow-none"}[r]:{primary:"border-2 border-accent shadow-input-accent hover:shadow-lg-accent focus:ring-2 focus:ring-accent focus:shadow-lg-accent active:bg-base",secondary:"border-2 border-secondary shadow-secondary/30 hover:shadow-secondary focus:ring-2 focus:ring-secondary focus:shadow-secondary active:bg-base",danger:"border-2 border-error shadow-error/30 hover:shadow-error focus:ring-2 focus:ring-error focus:shadow-error active:bg-base",ghost:"border border-border-default shadow-none hover:border-accent focus:ring-2 focus:ring-accent focus:border-accent active:bg-base"}[r],A=r=>({primary:"text-accent",secondary:"text-secondary",danger:"text-error",ghost:"text-muted"})[r],_=H(D,q(R),z(I,!!t,x),C),T=A(I),P=t?`${l}-error`:y?`${l}-help`:void 0;return e.jsxs("div",{className:"space-y-2",children:[S&&e.jsx("label",{htmlFor:l,className:"block text-sm font-medium text-default",children:S}),e.jsxs("div",{className:"relative",children:[s&&e.jsx("div",{className:`absolute inset-y-0 left-0 flex items-center pl-3 ${T}`,children:s}),e.jsx("input",{className:_,disabled:x,id:l,"aria-invalid":!!t,"aria-describedby":P,...w}),o&&e.jsx("div",{className:`absolute inset-y-0 right-0 flex items-center pr-3 ${T}`,children:o})]}),(y||t)&&e.jsx("div",{id:t?`${l}-error`:`${l}-help`,className:`text-xs font-mono ${t?"text-error":"text-muted"}`,children:t||y})]})};a.__docgenInfo={description:`A highly customizable Cyberpunk input field with support for icons, labels, and error states.
...
<Input 
  ...
  error="Access Denied" 
  leftIcon={<LockIcon />} 
/>`,methods:[],displayName:"Input",props:{variant:{required:!1,tsType:{name:"union",raw:"'primary' | 'secondary' | 'danger' | 'ghost'",elements:[{name:"literal",value:"'primary'"},{name:"literal",value:"'secondary'"},{name:"literal",value:"'danger'"},{name:"literal",value:"'ghost'"}]},description:`Visual style of the input.
