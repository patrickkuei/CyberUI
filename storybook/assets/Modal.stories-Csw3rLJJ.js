import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as o}from"./iframe-Bn34fd_r.js";import{r as G}from"./index-CxmlqWOz.js";import{B as b}from"./Button-DaG5DMSp.js";import{c as x}from"./cn-CNMN3A1O.js";import{u as H}from"./useDialogBehavior-Cg9NJ_Zk.js";import"./preload-helper-D9Z9MdNV.js";import"./index-BJtHEhC0.js";import"./responsive-B9k3icnG.js";import"./usePrefersReducedMotion-pjvglmNK.js";const Z={openDuration:600,closeDuration:400,crtEffects:!0},J={sm:"max-w-md",md:"max-w-lg",lg:"max-w-2xl",xl:"max-w-4xl",fullscreen:"max-w-none w-full h-full"},g=o.memo(({isOpen:n,onClose:y,title:r,children:m,footer:l,onCancel:p,onConfirm:u,cancelText:R="Cancel",confirmText:A="Confirm",confirmLoading:T=!1,showCancel:S=!0,showConfirm:E=!0,size:C="lg",variant:a="default",closeOnOverlayClick:D=!0,closeOnEscape:I=!0,animation:v,className:w="",overlayClassName:B="",showCloseButton:z=!0,onOpen:N,onCRTBootComplete:$})=>{const i=o.useMemo(()=>({...Z,...v}),[v]),j=o.useRef(null),k=o.useRef(`modal-title-${Math.random().toString(36).slice(2)}`),O=o.useRef(!1),{overlayRef:L,isOpening:t,isClosing:c,close:d,handleOverlayClick:P}=H(n,{closeDuration:i.closeDuration,openDuration:i.openDuration,closeOnEscape:I,closeOnOutsideClick:D,lockScroll:!0,onOpenSettle:()=>{$?.(),j.current?.focus()},onClose:y});o.useEffect(()=>{n&&!O.current&&N?.(),O.current=n},[n,N]);const F=o.useCallback(()=>{p?.(),d()},[p,d]),U=o.useCallback(()=>{u?.(),d()},[u,d]),q=o.useMemo(()=>{const s=a==="danger",f=s?"border-error":"border-accent",M=s?"shadow-error":"shadow-lg-accent",W=s?"shadow-error/50":"shadow-input-accent/50",_=s?"animate-danger-glow":"animate-rgb-glow";return x("relative bg-surface border-2 rounded-lg max-h-[90vh] overflow-hidden flex flex-col transform transition-all duration-300 motion-reduce:duration-150 motion-reduce:scale-100",J[C],i.crtEffects&&t?`animate-crt-power-on ${f} ${M}`:i.crtEffects&&c?`animate-crt-power-off ${f} ${M}`:c?`scale-95 opacity-0 ${f}/20`:t?`scale-105 opacity-90 ${f} ${W}`:`scale-100 opacity-100 ${_}`,w)},[C,i.crtEffects,c,t,w,a]);return n?G.createPortal(e.jsx("div",{ref:L,className:`fixed z-50 flex items-center justify-center p-4 transition-all ease-out ${B} ${c?"bg-black/0 backdrop-blur-none opacity-0 duration-800":t?"bg-black/30 backdrop-blur-md opacity-100 duration-500":"bg-black/30 backdrop-blur-sm opacity-100 duration-300"} motion-reduce:duration-150`,style:{top:0,left:0,width:"100vw",height:"100vh"},onClick:P,"aria-hidden":!0,children:e.jsxs("div",{ref:j,className:q,onClick:s=>s.stopPropagation(),role:"dialog","aria-modal":"true","aria-labelledby":r?k.current:void 0,tabIndex:-1,children:[z&&e.jsx("button",{onClick:d,className:`absolute top-4 right-4 text-muted hover:text-accent transition-all duration-300 motion-reduce:duration-150 motion-reduce:scale-100 motion-reduce:rotate-0 motion-reduce:hover:scale-100 z-20 rounded-full w-8 h-8 flex items-center justify-center cursor-pointer transform ${c?"scale-0 rotate-180 opacity-0":t?"scale-0 opacity-0":"scale-100 opacity-100 hover:scale-110 hover:bg-accent/10"}`,"aria-label":"Close modal",children:e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 16 16",fill:"none",className:"relative",children:e.jsx("path",{d:"M12 4L4 12M4 4L12 12",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round"})})}),r&&e.jsx("div",{className:x("px-6 py-4 border-b flex-shrink-0 transition-all duration-300 motion-reduce:duration-150 motion-reduce:translate-y-0 motion-reduce:opacity-100",a==="danger"?"border-error/20":"border-accent/20",t?"opacity-0 translate-y-2":"opacity-100 translate-y-0"),children:e.jsx("h2",{id:k.current,className:x("text-lg font-semibold",a==="danger"?"text-error":"text-primary"),children:r})}),e.jsx("div",{className:`flex-1 overflow-auto p-6 transition-all duration-500 motion-reduce:duration-150 motion-reduce:translate-y-0 motion-reduce:opacity-100 ${t?"opacity-0 translate-y-4":"opacity-100 translate-y-0"}`,children:m}),(l||p||u)&&e.jsx("div",{className:x("px-6 py-4 border-t flex-shrink-0 transition-all duration-300 motion-reduce:duration-150 motion-reduce:translate-y-0 motion-reduce:opacity-100",a==="danger"?"border-error/20":"border-accent/20",t?"opacity-0 translate-y-2":"opacity-100 translate-y-0"),children:l||e.jsxs("div",{className:"flex flex-col-reverse sm:flex-row justify-between items-center gap-3",children:[e.jsx("span",{className:"text-muted text-xs font-mono hidden sm:block",children:"> ESC to abort"}),e.jsxs("div",{className:"flex gap-3 w-full sm:w-auto",children:[S&&p&&e.jsx(b,{variant:"ghost",size:"sm",onClick:F,className:"flex-1 sm:flex-none",children:R}),E&&u&&e.jsx(b,{variant:a==="danger"?"danger":"primary",size:"sm",onClick:U,disabled:T,className:"flex-1 sm:flex-none",children:A})]})]})})]})}),document.body):null});g.displayName="CyberUI.Modal";const re={title:"Components/Modal",component:g,parameters:{layout:"centered",docs:{description:{component:`A cyberpunk-themed modal dialog with CRT Power-on Effect animation, overlay backdrop, and portal rendering.
...
}`,...h.parameters?.docs?.source}}};const le=["Default"];export{h as Default,le as __namedExportsOrder,re as default};
