import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as s}from"./iframe-B52jae2o.js";import{u as L,g as E,R as z}from"./responsive-ChLhblTX.js";import{D as i}from"./index-Dm1LNrgC.js";import"./preload-helper-PPVm8Dsz.js";const M=({tabs:a,activeTab:l,onTabChange:g,sizeClasses:R,containerClassName:N="",anchorClassName:u="",menuClassName:j="",menuItemClassName:S="",dropdownLabel:p,anchorIcon:I,showAnchorLabel:f=!0,anchorAriaLabel:A,closeOnSelect:D=!0})=>{const[n,d]=s.useState(!1),[k,b]=s.useState(!1),[c,o]=s.useState(!1),[y,t]=s.useState(!1),q=s.useRef(null),O=s.useRef(null);s.useEffect(()=>{if(!n)return;const r=V=>{q.current&&!q.current.contains(V.target)&&(o(!0),setTimeout(()=>{d(!1),o(!1)},180))};return document.addEventListener("mousedown",r),()=>document.removeEventListener("mousedown",r)},[n]),s.useEffect(()=>{if(!n)return;const r=O.current;if(!r)return;const V=r.getBoundingClientRect();t(V.right>window.innerWidth)},[n]);const H=()=>{n?(o(!0),setTimeout(()=>{d(!1),o(!1)},180)):(b(!0),d(!0),setTimeout(()=>b(!1),30))};return e.jsx("div",{className:`${N}`,children:e.jsxs("div",{ref:q,className:"relative inline-block",children:[e.jsxs("button",{onClick:H,className:`inline-flex items-center gap-2 ${R} bg-surface text-default border-2 border-border-default rounded-lg transition-all duration-300 hover:text-secondary hover:border-secondary hover:cursor-pointer shadow-secondary/30 ${u}`,"aria-haspopup":"menu","aria-expanded":n,"aria-label":f?void 0:A??(typeof p=="string"?p:"Open tabs"),children:[I??e.jsxs("svg",{className:"w-5 h-5",viewBox:"0 0 20 20",fill:"currentColor","aria-hidden":"true",children:[e.jsx("rect",{x:"3",y:"5",width:"14",height:"2",rx:"1"}),e.jsx("rect",{x:"3",y:"9",width:"14",height:"2",rx:"1"}),e.jsx("rect",{x:"3",y:"13",width:"14",height:"2",rx:"1"})]}),f&&e.jsx("span",{children:p??l})]}),(n||c)&&e.jsx("div",{ref:O,"aria-hidden":!n,className:`absolute ${y?"right-0":"left-0"} mt-2 min-w-40 z-50 bg-surface border-2 border-border-default rounded-lg shadow-secondary overflow-hidden ${j}
              transition-transform transition-opacity duration-200 ease-[cubic-bezier(.2,0,0,1)] transform-gpu origin-top will-change-transform will-change-opacity ${k||c?"opacity-0 scale-y-0 pointer-events-none":"opacity-100 scale-y-100 pointer-events-auto"}`,children:e.jsx("div",{className:"py-1",children:a.map(r=>e.jsx("button",{onClick:()=>{g(r),D&&(o(!0),setTimeout(()=>{d(!1),o(!1)},180))},className:`w-full flex items-center justify-between text-left px-4 py-2 font-bold transition-colors duration-200 outline-none hover:cursor-pointer ${l===r?"text-secondary relative pl-4 before:content-[''] before:h-full before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:h-4 before:w-[3px] before:rounded before:bg-accent before:shadow-lg-accent":"text-default hover:text-secondary hover:bg-base/70"} ${S}`,children:e.jsx("span",{children:r})},r))})})]})})},m=({tabs:a,activeTab:l,onTabChange:g,size:R="md",mode:N="scroll",containerClassName:u="",tabsClassName:j="",dropdownLabel:S,anchorIcon:p,showAnchorLabel:I=!0,anchorAriaLabel:f,closeOnSelect:A=!0,anchorClassName:D="",menuClassName:n="",menuItemClassName:d=""})=>{const b=(t=>E(t,z.tabNavigation))(R),c=L(N,"scroll"),o=()=>{switch(c){case"scroll":return"w-full overflow-x-auto overflow-y-hidden scrollbar-thin scrollbar-thumb-border-default scrollbar-track-transparent hover:scrollbar-thumb-secondary/50 py-1";case"wrap":return"flex flex-wrap gap-2";case"dropdown":case"collapsible":return"flex space-x-2";default:return"flex space-x-2"}},y=e.jsx(e.Fragment,{children:a.map(t=>e.jsx("button",{onClick:()=>g(t),className:`
            ...
            ${l===t?"text-secondary after:bg-linear-(--gradient-accent) after:shadow-lg-accent after:scale-x-100":"text-muted hover:text-secondary hover:before:opacity-70"}
            ${j}
          `,role:"tab","aria-selected":l===t,tabIndex:l===t?0:-1,children:t},t))});return c==="dropdown"?e.jsx(M,{tabs:a,activeTab:l,onTabChange:g,sizeClasses:b,containerClassName:u,anchorClassName:D,menuClassName:n,menuItemClassName:d,dropdownLabel:S,anchorIcon:p,showAnchorLabel:I,anchorAriaLabel:f,closeOnSelect:A}):c==="scroll"?e.jsx("div",{className:`${o()} ${u}`,role:"tablist","aria-label":"Tabs",children:e.jsx("div",{className:"w-max mx-auto flex space-x-2",children:y})}):e.jsx("div",{className:`${o()} ${u}`,role:"tablist","aria-label":"Tabs",children:y})};m.__docgenInfo={description:"",methods:[],displayName:"TabNavigation",props:{tabs:{required:!0,tsType:{name:"unknown"},description:"List of tab labels."},activeTab:{required:!0,tsType:{name:"string"},description:"Currently active tab label."},onTabChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(tab: string) => void",signature:{arguments:[{type:{name:"string"},name:"tab"}],return:{name:"void"}}},description:"Callback when a tab is selected."},size:{required:!1,tsType:{name:"union",raw:"T | ResponsiveObject<T>",elements:[{name:"union",raw:'"sm" | "md" | "lg"',elements:[{name:"literal",value:'"sm"'},{name:"literal",value:'"md"'},{name:"literal",value:'"lg"'}]},{name:"signature",type:"object",raw:`{
  base?: T;
  sm?: T;
  md?: T;
  lg?: T;
...
}`,...C.parameters?.docs?.source}}};const U=["Default","DropdownMode","ResponsiveModes","DropdownCustomLabel","DropdownCustomIcon","DropdownIconOnly"];export{v as Default,x as DropdownCustomIcon,T as DropdownCustomLabel,C as DropdownIconOnly,h as DropdownMode,w as ResponsiveModes,U as __namedExportsOrder,F as default};
