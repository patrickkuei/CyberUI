...
- **Accessibility:** Full ARIA support with focus management and screen reader compatibility — Escape restores focus to whatever triggered the modal, but a click on the overlay doesn't (a pointer dismissal already tells the browser where focus should go)
