import{j as a}from"./jsx-runtime-D_zvdyIk.js";import{r as o}from"./iframe-91luHy9z.js";import{g as Pe,R as Ve}from"./responsive-CYBOpSLp.js";import{c as k}from"./cn-CNMN3A1O.js";import"./preload-helper-D9Z9MdNV.js";const Ae=["Su","Mo","Tu","We","Th","Fr","Sa"],ue=["January","February","March","April","May","June","July","August","September","October","November","December"],C=t=>{const r=new Date(t);return r.setHours(0,0,0,0),r},X=(t,r)=>t.getFullYear()===r.getFullYear()&&t.getMonth()===r.getMonth()&&t.getDate()===r.getDate(),g=(t,r)=>{const s=new Date(t);return s.setDate(s.getDate()+r),s},V=(t,r)=>{const s=t.getDate(),l=new Date(t);l.setDate(1),l.setMonth(l.getMonth()+r);const h=new Date(l.getFullYear(),l.getMonth()+1,0).getDate();return l.setDate(Math.min(s,h)),l},N=(t,r,s)=>!!(r&&t<C(r)||s&&t>C(s)),A=t=>{const r=t.getFullYear(),s=String(t.getMonth()+1).padStart(2,"0"),l=String(t.getDate()).padStart(2,"0");return`${r}-${s}-${l}`},Re=t=>{const r=t.getMonth(),s=new Date(t.getFullYear(),r,1),l=g(s,-s.getDay());return Array.from({length:42},(h,T)=>{const M=g(l,T);return{date:M,inCurrentMonth:M.getMonth()===r}})},Ie=t=>{const r=[];for(let s=0;s<t.length;s+=7)r.push(t.slice(s,s+7));return r},c=({value:t,defaultValue:r=null,onValueChange:s,minDate:l,maxDate:h,label:T,placeholder:M="Select a date...",variant:ee="primary",size:me="md",disabled:m=!1,helperText:_,error:y,formatDate:pe=A,ariaLabel:ge="Choose date",className:he="",id:fe})=>{const ae=t!==void 0,[be,ye]=o.useState(r),v=ae?t:be,te=C(v??new Date),[p,E]=o.useState(te),[j,H]=o.useState(te),[d,re]=o.useState(!1),[x,K]=o.useState(!1),ne=o.useId(),w=fe||ne,se=`datepicker-calendar-${ne}`,ve=y?`${w}-error`:_?`${w}-help`:void 0,G=o.useRef(null),oe=o.useRef(null),f=o.useRef(null),J=o.useRef({}),P=o.useRef(!1);o.useEffect(()=>()=>{f.current&&clearTimeout(f.current)},[]);const b=o.useCallback(e=>{K(!0),f.current&&clearTimeout(f.current),f.current=setTimeout(()=>{re(!1),K(!1),e&&oe.current?.focus()},180)},[]),Z=o.useCallback(()=>{if(m)return;f.current&&(clearTimeout(f.current),f.current=null),K(!1);const e=C(v??new Date);E(e),H(e),re(!0),P.current=!0},[m,v]),le=o.useCallback(()=>{d&&!x?b(!1):Z()},[d,x,Z,b]);o.useEffect(()=>{if(!d)return;const e=n=>{G.current&&!G.current.contains(n.target)&&b(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[d,b]),o.useEffect(()=>{!d||!P.current||(P.current=!1,J.current[A(j)]?.focus())},[d]),o.useEffect(()=>{d&&!P.current&&J.current[A(j)]?.focus()},[j,d]);const u=e=>{let n=e;if(N(n,l,h)){const i=n.getTime()<j.getTime()?1:-1;let D=0;const S=3660;for(;N(n,l,h)&&D<S;)n=g(n,i),D++;if(N(n,l,h))return}H(n),(n.getMonth()!==p.getMonth()||n.getFullYear()!==p.getFullYear())&&E(n)},ie=e=>{N(e,l,h)||(ae||ye(e),s?.(e),b(!0))},De=e=>{m||(e.key==="ArrowDown"||e.key==="Enter"||e.key===" "?(e.preventDefault(),(!d||x)&&Z()):e.key==="Escape"&&d&&!x&&(e.preventDefault(),b(!1)))},xe=(e,n)=>{switch(e.key){case"ArrowLeft":e.preventDefault(),u(g(n,-1));break;case"ArrowRight":e.preventDefault(),u(g(n,1));break;case"ArrowUp":e.preventDefault(),u(g(n,-7));break;case"ArrowDown":e.preventDefault(),u(g(n,7));break;case"Home":e.preventDefault(),u(g(n,-n.getDay()));break;case"End":e.preventDefault(),u(g(n,6-n.getDay()));break;case"PageUp":e.preventDefault(),u(V(n,-1));break;case"PageDown":e.preventDefault(),u(V(n,1));break;case"Enter":case" ":e.preventDefault(),ie(n);break;case"Escape":e.preventDefault(),b(!0);break;case"Tab":b(!1);break}},we=()=>{const e=V(p,-1);E(e),u(e)},Se=()=>{const e=V(p,1);E(e),u(e)},ke=e=>Pe(e,Ve.input),je=(e,n,i)=>n?"border-2 border-error shadow-error/30 hover:shadow-error focus:ring-2 focus:ring-error focus:shadow-error active:bg-base":i?{primary:"border-2 border-accent/20 shadow-none",secondary:"border-2 border-secondary/20 shadow-none",danger:"border-2 border-error/20 shadow-none",ghost:"border border-border-default shadow-none"}[e]:{primary:"border-2 border-accent shadow-input-accent hover:shadow-lg-accent focus:ring-2 focus:ring-accent focus:shadow-lg-accent active:bg-base",secondary:"border-2 border-secondary shadow-secondary/30 hover:shadow-secondary focus:ring-2 focus:ring-secondary focus:shadow-secondary active:bg-base",danger:"border-2 border-error shadow-error/30 hover:shadow-error focus:ring-2 focus:ring-error focus:shadow-error active:bg-base",ghost:"border border-border-default shadow-none hover:border-accent focus:ring-2 focus:ring-accent focus:border-accent active:bg-base"}[e],Ne=m?"text-muted/50":{primary:"text-accent",secondary:"text-secondary",danger:"text-error",ghost:"text-muted"}[ee],Ce=k("w-full rounded-lg bg-surface text-default placeholder-muted transition-all duration-300 focus:outline-none pl-4 pr-10",m?"cursor-not-allowed opacity-60":"cursor-pointer",ke(me),je(ee,!!y,m)),Te=Ie(Re(p)),Me=C(new Date);return a.jsxs("div",{className:k("w-full",he),ref:G,children:[T&&a.jsx("label",{htmlFor:w,className:"block text-sm font-medium text-default mb-2",children:T}),a.jsxs("div",{className:"relative",children:[a.jsx("input",{ref:oe,type:"text",readOnly:!0,role:"combobox","aria-haspopup":"dialog","aria-expanded":d,"aria-controls":se,"aria-invalid":!!y,"aria-describedby":ve,id:w,value:v?pe(v):"",placeholder:M,disabled:m,onClick:le,onKeyDown:De,className:Ce}),a.jsx("button",{type:"button",tabIndex:-1,"aria-hidden":"true",disabled:m,onClick:le,className:k("absolute inset-y-0 right-0 flex items-center pr-3",m?"cursor-not-allowed":"cursor-pointer",Ne),children:a.jsx("svg",{className:"w-4 h-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:a.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"})})}),(d||x)&&a.jsxs("div",{id:se,role:"dialog","aria-label":ge,"aria-hidden":!d,className:k("absolute z-50 mt-2 w-72 rounded-lg border-2 border-border-default bg-surface p-4 shadow-secondary","transition-transform transition-opacity duration-200 ease-[cubic-bezier(.2,0,0,1)] transform-gpu origin-top will-change-transform will-change-opacity",x?"pointer-events-none scale-y-0 opacity-0":"pointer-events-auto scale-y-100 opacity-100"),children:[a.jsxs("div",{className:"mb-3 flex items-center justify-between",children:[a.jsx("button",{type:"button","aria-label":"Previous month",onClick:we,className:"rounded p-1 text-accent hover:text-secondary focus:outline-none focus-visible:ring-2 focus-visible:ring-secondary/70",children:a.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:a.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M15 19l-7-7 7-7"})})}),a.jsxs("span",{className:"font-mono text-sm font-bold text-default","aria-live":"polite",children:[ue[p.getMonth()]," ",p.getFullYear()]}),a.jsx("button",{type:"button","aria-label":"Next month",onClick:Se,className:"rounded p-1 text-accent hover:text-secondary focus:outline-none focus-visible:ring-2 focus-visible:ring-secondary/70",children:a.jsx("svg",{className:"h-4 w-4",fill:"none",stroke:"currentColor",viewBox:"0 0 24 24",children:a.jsx("path",{strokeLinecap:"round",strokeLinejoin:"round",strokeWidth:2,d:"M9 5l7 7-7 7"})})})]}),a.jsxs("div",{role:"grid","aria-label":`${ue[p.getMonth()]} ${p.getFullYear()}`,children:[a.jsx("div",{role:"row",className:"grid grid-cols-7 mb-1",children:Ae.map(e=>a.jsx("div",{role:"columnheader",className:"text-center text-xs font-mono text-muted",children:e},e))}),Te.map((e,n)=>a.jsx("div",{role:"row",className:"grid grid-cols-7",children:e.map(i=>{const D=N(i.date,l,h),S=!!v&&X(i.date,v),de=X(i.date,Me),Ee=X(i.date,j),ce=A(i.date);return a.jsx("button",{ref:Q=>{J.current[ce]=Q},type:"button",role:"gridcell","aria-selected":S,"aria-disabled":D||void 0,"aria-current":de?"date":void 0,tabIndex:Ee?0:-1,disabled:D,onClick:()=>ie(i.date),onKeyDown:Q=>xe(Q,i.date),onFocus:()=>H(i.date),className:k("m-0.5 flex h-8 items-center justify-center rounded-md font-mono text-sm outline-none transition-colors duration-150 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-secondary/70",!i.inCurrentMonth&&"text-muted/30",D?"cursor-not-allowed text-muted/30 opacity-50":i.inCurrentMonth?"cursor-pointer text-default hover:bg-base/70 hover:text-secondary":"cursor-pointer",S&&"bg-accent text-inverse font-bold shadow-primary hover:bg-accent hover:text-inverse",!S&&de&&"border border-accent text-accent shadow-primary/50"),children:i.date.getDate()},ce)})},n))]})]})]}),(_||y)&&a.jsx("div",{id:y?`${w}-error`:`${w}-help`,className:k("mt-2 text-xs font-mono",y?"text-error":"text-muted"),children:y||_})]})};c.displayName="CyberUI.DatePicker";c.__docgenInfo={description:`A cyberpunk-styled single-date picker: a text-input trigger (matching
