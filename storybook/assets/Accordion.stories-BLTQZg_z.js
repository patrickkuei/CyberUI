import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as u}from"./iframe-Bn34fd_r.js";import{g as Y,R as B}from"./responsive-B9k3icnG.js";import{c as p}from"./cn-CNMN3A1O.js";import"./preload-helper-D9Z9MdNV.js";const a=({items:r,mode:g="single",defaultOpenIds:d,openIds:v,onOpenIdsChange:T,size:C="md",className:D=""})=>{const z=u.useId(),[_,q]=u.useState(d??[]),j=v!==void 0,c=j?v:_,k=u.useRef([]),M=r.map((s,i)=>({...s,resolvedId:s.id??`${z}-item-${i}`})),R=u.useCallback(s=>{const i=c.includes(s),n=g==="multiple"?i?c.filter(l=>l!==s):[...c,s]:i?[]:[s];j||q(n),T?.(n)},[g,c,j,T]),h=s=>{k.current[s]?.focus()},P=(s,i)=>{const n=M.map((t,m)=>t.disabled?-1:m).filter(t=>t!==-1);if(n.length===0)return;const l=n.indexOf(i);switch(s.key){case"ArrowDown":{s.preventDefault();const t=(l+1)%n.length;h(n[t]);break}case"ArrowUp":{s.preventDefault();const t=(l-1+n.length)%n.length;h(n[t]);break}case"Home":{s.preventDefault(),h(n[0]);break}case"End":{s.preventDefault(),h(n[n.length-1]);break}}},L=Y(C,B.accordion);return e.jsx("div",{className:p("flex flex-col gap-3",D),children:M.map((s,i)=>{const n=c.includes(s.resolvedId),l=`${s.resolvedId}-header`,t=`${s.resolvedId}-panel`;return e.jsxs("div",{className:p("rounded-lg border bg-surface transition-colors duration-300 overflow-hidden",n?"border-accent shadow-md-accent":"border-border-default"),children:[e.jsx("h3",{className:"m-0",children:e.jsxs("button",{ref:m=>{k.current[i]=m},type:"button",id:l,"aria-expanded":n,"aria-controls":t,disabled:s.disabled,onClick:()=>R(s.resolvedId),onKeyDown:m=>P(m,i),className:p("flex w-full items-center justify-between gap-3 text-left font-bold transition-colors duration-200 outline-none",L,s.disabled?"text-muted/40 cursor-not-allowed":p("cursor-pointer hover:text-secondary",n?"text-secondary":"text-default")),children:[e.jsx("span",{children:s.title}),e.jsx("span",{"aria-hidden":"true",className:p("shrink-0 text-sm transition-transform duration-300 motion-reduce:transition-none",n?"rotate-180 text-accent":"rotate-0 text-muted"),children:"▾"})]})}),e.jsx("div",{className:"grid transition-[grid-template-rows] duration-300 ease-out motion-reduce:transition-none",style:{gridTemplateRows:n?"1fr":"0fr"},children:e.jsx("div",{className:"overflow-hidden",children:e.jsx("div",{id:t,role:"region","aria-labelledby":l,"aria-hidden":!n,inert:!n,className:"px-4 pb-4 text-sm text-muted",children:s.content})})})]},s.resolvedId)})})};a.displayName="CyberUI.Accordion";a.__docgenInfo={description:`A cyberpunk-styled collapsible section list for FAQs, settings panels,
...
}`,...N.parameters?.docs?.source}}};const G=["Default","SingleMode","MultipleMode","Small","Medium","Large","Disabled","Controlled","AllVariants"];export{N as AllVariants,A as Controlled,x as Default,S as Disabled,w as Large,I as Medium,y as MultipleMode,f as SingleMode,b as Small,G as __namedExportsOrder,Q as default};
